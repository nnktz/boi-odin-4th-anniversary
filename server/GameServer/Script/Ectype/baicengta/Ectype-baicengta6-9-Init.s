	...
	//		Modified：2011/11/01
	//		Author：朱建臣
	//		TaskName：Ectype-baicengta6-9-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function EctypeTime1(){
		...
		if $decrease != 1
			AddLevelMonster( $smid, $sstr, 120, 11, $ectype_ID, 28, 21, 4 )
		endif
		if $decrease != 2
			AddLevelMonster( $smid, $sstr, 120, 11, $ectype_ID, 22, 27, 4 )
		endif
		if $decrease != 3
			AddLevelMonster( $smid, $sstr, 120, 11, $ectype_ID, 28, 33, 4 )
		endif
		if $decrease != 4
			AddLevelMonster( $smid, $sstr, 120, 11, $ectype_ID, 34, 27, 4 )
		endif
