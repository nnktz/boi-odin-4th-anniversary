	...
	//		Modified：2012/02/20
	//		Author：张文宇
	//		TaskName：Ectype-baicengta91-99-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function InitTimer(){
		...
		if $c == 0
			AddMonsterByFloat( 55329, 1, $ectype_ID, 202, 130, 0 )
		endif
	...
	function Spawn(){
		...
		//刷头领
		AddLevelFieldMonster($ba,$bb,120,85,40,4,$ectype_ID,74,61,11)
