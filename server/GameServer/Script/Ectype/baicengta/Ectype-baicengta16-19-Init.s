	...
	//		Modified：2011/11/01
	//		Author：朱建臣
	//		TaskName：Ectype-baicengta16-19-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function EctypeTime1(){
		...
		if $decrease != 1
			AddLevelMonster( $smid, $sstr, 120, 13, $ectype_ID, 59, 68, 4 )
		endif                                                       
		if $decrease != 2                                           
			AddLevelMonster( $smid, $sstr, 120, 13, $ectype_ID, 51, 74, 4 )
		endif                                                       
		if $decrease != 3                                           
			AddLevelMonster( $smid, $sstr, 120, 13, $ectype_ID, 59, 81, 4 )
		endif                                                       
		if $decrease != 4                                           
			AddLevelMonster( $smid, $sstr, 120, 13, $ectype_ID, 67, 75, 4 )
		endif
