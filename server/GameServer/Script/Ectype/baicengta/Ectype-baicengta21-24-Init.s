	...
	//		Modified：2011/11/01
	//		Author：朱建臣
	//		TaskName：Ectype-baicengta21-24-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function EctypeTime1(){
		...
		if $decrease != 1
			AddLevelMonster( $smid, $sstr, 120, 14, $ectype_ID, 66, 62, 4 )
		endif                                                          
		if $decrease != 2                                              
			AddLevelMonster( $smid, $sstr, 120, 14, $ectype_ID, 64, 53, 4 )
		endif                                                          
		if $decrease != 3                                              
			AddLevelMonster( $smid, $sstr, 120, 14, $ectype_ID, 53, 62, 4 )
		endif                                                          
		if $decrease != 4                                              
			AddLevelMonster( $smid, $sstr, 120, 14, $ectype_ID, 59, 66, 4 )
		endif
