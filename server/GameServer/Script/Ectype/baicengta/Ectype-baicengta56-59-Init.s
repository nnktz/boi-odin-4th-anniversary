	...
	//		Modified：2011/11/01
	//		Author：朱建臣
	//		TaskName：Ectype-baicengta56-59-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function EctypeTime1(){
		...
		if $decrease != 1
			AddLevelMonster( $smid, $sstr, 120, 21, $ectype_ID, 54, 55, 4  )
		endif                                                           
		if $decrease != 2                                               
			AddLevelMonster( $smid, $sstr, 120, 21, $ectype_ID, 65, 55, 4  )
		endif                                                           
		if $decrease != 3                                               
			AddLevelMonster( $smid, $sstr, 120, 21, $ectype_ID, 54, 66, 4  )
		endif                                                           
		if $decrease != 4                                               
			AddLevelMonster( $smid, $sstr, 120, 21, $ectype_ID, 65, 66, 4  )
		endif
