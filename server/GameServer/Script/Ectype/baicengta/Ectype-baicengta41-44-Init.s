	...
	//		Modified：2011/11/01
	//		Author：朱建臣
	//		TaskName：Ectype-baicengta41-44-Init.s
	//		TaskID：
	//
	//****************************************
	...
	function EctypeTime1(){
		...
		if $decrease != 1
			AddLevelMonster( $smid, $sstr, 120, 18, $ectype_ID, 55, 56, 4 )
		endif                                                          
		if $decrease != 2                                              
			AddLevelMonster( $smid, $sstr, 120, 18, $ectype_ID, 54, 62, 4 )
		endif                                                          
		if $decrease != 3                                              
			AddLevelMonster( $smid, $sstr, 120, 18, $ectype_ID, 64, 56, 4 )
		endif                                                          
		if $decrease != 4                                              
			AddLevelMonster( $smid, $sstr, 120, 18, $ectype_ID, 64, 62, 4 )
		endif
