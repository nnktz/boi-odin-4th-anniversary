...
//			endif
			...
			if $IsFinished == 1
//				BC("screen", "map", $ectype_ID, "GUID:04608000002")
				OpenMask( 1 ,$ectype_ID )
			else
				
//				BC("screen", "map", $ectype_ID, "GUID:04608000003")
			endif
			
			$IsFinished1 = GetPlayerVar( -1 , 53 )
			if $IsFinished1 == 1
//				BC("screen", "map", $ectype_ID, "GUID:04608000004")
				OpenMask( 2 ,$ectype_ID )
			else
				
//				BC("screen", "map", $ectype_ID, "GUID:04608000005")
			endif
			
			$TaskDone = IsTaskDone( -1 , 231 )
			if $TaskDone == 0 
//				BC("screen", "map", $ectype_ID, "GUID:04608000006")
				OpenMask( 3 ,$ectype_ID )
				OpenMask( 5 ,$ectype_ID )
			else
				
//				BC("screen", "map", $ectype_ID, "GUID:04608000007")
			endif
			...
			if $SwordInfo == 0
//				BC("screen", "map", $ectype_ID, "GUID:04608000008") 
				//??6???
			...
			if $SwordInfo > 0
				if $SwordInfo < 6
//					BC("screen", "map", $ectype_ID, "GUID:04608000009") 
					//??????????
					DeleteNPC(499, $ectype_ID )
					DeleteNPC(506, $ectype_ID )
					...
					if $Done == 0
//						BC("screen", "map", $ectype_ID, "GUID:04608000010") 
						DeleteNPC(533, $ectype_ID )
						DeleteNPC(534, $ectype_ID )
						DeleteNPC(535, $ectype_ID )
						DeleteNPC(536, $ectype_ID )
...
//				if $player1_number > 0
//					#name = GetPlayerInfo( $teamplayer1_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000017" )
//					$Stop = $Stop + 1
//				endif
//			endif
...
//				if $player2_number > 0
//					#name = GetPlayerInfo( $teamplayer2_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000019" )
//					$Stop = $Stop + 1
//				endif
//			endif
		endif
...
//				if $player3_number > 0
//					#name = GetPlayerInfo( $teamplayer3_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000021" )
//					$Stop = $Stop + 1
//				endif
//			endif
		endif
...
//				if $player4_number > 0
//					#name = GetPlayerInfo( $teamplayer4_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000023" )
//					$Stop = $Stop + 1
//				endif
//			endif
		endif
...
//				if $player5_number > 0
//					#name = GetPlayerInfo( $teamplayer5_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000025" )
//					$Stop = $Stop + 1
//				endif
//			endif
		endif
...
//				if $player6_number > 0
//					#name = GetPlayerInfo( $teamplayer6_id, "name", )
//					BC( "chat", "player", -1, #name ,"GUID:04608000027" )
//					$Stop = $Stop + 1
//				endif
//			endif
		endif
