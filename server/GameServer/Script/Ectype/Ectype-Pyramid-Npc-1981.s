...
//		if $Line != 8
//			if $Line != 7
//				BC( "dialogbox", "player", -1, "GUID:04346000099" )
//				return
//			endif
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04346000100" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 50036 )
//		if $item < 30
//			BC( "dialogbox", "player", -1, "GUID:04346000101" )
//			return
//		endif
//		
...
//		if $Line != 8
//			if $Line != 7
//				BC( "dialogbox", "player", -1, "GUID:04346000102" )
//				return
//			endif
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04346000103" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 50036 )
//		if $item < 30
//			BC( "dialogbox", "player", -1, "GUID:04346000104" )
//			return
//		endif
//		
//		$Sub = SubPlayerInfo( -1, "item", 50036, 30 )
...
//		if $Line != 8
//			if $Line != 7
//				BC( "dialogbox", "player", -1, "GUID:04346000105" )
//				return
//			endif
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04346000106" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 50036 )
//		if $item < 30
//			BC( "dialogbox", "player", -1, "GUID:04346000107" )
//			return
//		endif
//		
//		$Sub = SubPlayerInfo( -1, "item", 50036, 30 )
...
//		if $Line != 8
//			if $Line != 7
//				BC( "dialogbox", "player", -1, "GUID:04346000108" )
//				return
//			endif
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04346000109" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 50036 )
//		if $item < 30
//			BC( "dialogbox", "player", -1, "GUID:04346000110" )
//			return
//		endif
//		
//		$Sub = SubPlayerInfo( -1, "item", 50036, 30 )
