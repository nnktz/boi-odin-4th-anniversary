...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000116" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 10
//			BC( "dialogbox", "player", -1, "GUID:04294000117" )
//			return
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000118" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 6
//			BC( "dialogbox", "player", -1, "GUID:04294000119" )
//			return
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000120" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 5
//			BC( "dialogbox", "player", -1, "GUID:04294000121" )
//			return
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000122" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 5
//			BC( "dialogbox", "player", -1, "GUID:04294000123" )
//			return
//		endif
//		
//		$Sub = SubPlayerInfo( -1, "item", 12645, 5 )
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000124" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 3
//			BC( "dialogbox", "player", -1, "GUID:04294000125" )
//			return
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "dialogbox", "player", -1, "GUID:04294000126" )
//			return
//		endif
//		
//		$item = GetPlayerInfo( -1, "item", 12645 )
//		if $item < 2
//			BC( "dialogbox", "player", -1, "GUID:04294000127" )
//			return
//		endif
//		
