	...
	//		Modified:2009/07/25
	//		Author: ??
	//		TaskName:Ectype-HAQX-Monster-51215.s
	//		TaskID:??
	//****************************************
	...
	function OnDead(){
		...
		if $ectype_ID > 0
			...
			AddNPC(1968, $ectype_ID)
			AddNPC(2018, $ectype_ID)
			BC("screen", "map", $ectype_ID, "The Eastern Requiem Pillar appears! Destroy it as soon as you can!")
