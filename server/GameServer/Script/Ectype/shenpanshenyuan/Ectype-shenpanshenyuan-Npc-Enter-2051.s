...
//			if $week != 5
//				if $week != 0
//					BC( "dialogbox", "player", -1, "GUID:04799000000" )
//					return	
//				endif
//			endif
//		endif
		...
		StartEctypeTimer( $team_headerID , 228, 0 )
		//??????????
		$history = GetGlobalVar( 956 )
		$history = $history + $team_count
		SetGlobalVar( 956 , $history )
		//BC( "screen", "player", -1 , "GUID:04799000010" , $history , "GUID:04799000011" )
...
//			if $week != 5
//				if $week != 0
//					BC( "dialogbox", "player", -1, "GUID:04799000012" )
//					return	
//				endif
//			endif
//		endif
		...
		$history = $history + $team_count
		SetGlobalVar( 956 , $history )
		//BC( "screen", "player", -1 , "GUID:04799000023" , $history , "GUID:04799000024" )
...
//						if $week != 5
//							if $week != 0
//								BC( "dialogbox", "player", -1, "GUID:04799000028" )
//								return	
//							endif
//						endif
//					endif
