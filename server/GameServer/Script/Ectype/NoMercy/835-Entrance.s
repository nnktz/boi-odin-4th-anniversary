...
//				//???????
				...
				if $player_time == $today_time
					...
					BC( "dialogbox", "player", -1,"One or more party members have already entered Heartless Canyon today." )
					return
				endif
...
//				SetPlayerActLog(-1,26,0)
	...
	function OnOption3(){	
		...
		if $revalue == 0
			BC( "screen", "team", $team_headerID, "The Heartless Canyon instance is reset!" )
			BC( "dialogbox", "player", -1, "The Heartless Canyon instance is reset!" )
		else
