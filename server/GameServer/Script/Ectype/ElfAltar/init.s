	...
	function EctypeTimer0(){
		...
		$ectype_id = GetEctypeID( -1 , 541 )
//		BC( "chat", "map", $ectype_id, "GUID:04425000000")
...
//			BC("screen","map",$ectype_id,"GUID:04425000001")
//			BC("chat","map",$ectype_id,"GUID:04425000002")		
...
//  		BC("screen","map",$ectype_id,"GUID:04425000003")
//			BC("chat","map",$ectype_id,"GUID:04425000004")	
...
//			BC("screen","map",$ectype_id,"GUID:04425000005")
//			BC("chat","player",-1,"GUID:04425000006")		
...
//			BC("screen","map",$ectype_id,"GUID:04425000007")
//			BC("chat","player",-1,"GUID:04425000008")		
...
//		BC( "chat", "map", $ectype_id, "GUID:04425000009")
		if $turn == 0
		//??????
			if $runtime > 250
				return
...
//				BC("screen","map",$ectype_id,"GUID:04425000010")
//				BC("chat","player",-1,"GUID:04425000011")					
...
//					BC("screen","map",$ectype_id,"GUID:04425000012")
//					BC("chat","player",-1,"GUID:04425000013")						
	...
	function EctypeTimer4(){
		...
		//2?1?????
		$ectype_id = GetEctypeID( -1 , 541 )
//		BC( "chat", "map", $ectype_id, "GUID:04425000014")
...
//		BC( "screen", "map",$ectype_id, "GUID:04425000015",$time )
//		BC("chat","player",-1,"GUID:04425000016",$time)						
