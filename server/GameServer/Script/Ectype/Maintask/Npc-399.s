...
//			//BC( "chat" , "player" , -1 , "GUID:04770000006",$maxlv, )
//		endif
////---------?????????,?????????????????
//		if $spreadlv > $maxlv
//			$maxlv = $spreadlv
//			SetPlayerVar( -1 ,3288, $maxlv, )
//			//BC( "chat" , "player" , -1 , "GUID:04770000007",$maxlv, )
//		endif
//		
////---------?????????????????????,??????????????????,????????????
//
...
//			
//			$spreadlv = $maxlv
//			//BC( "chat" , "player" , -1 , "GUID:04770000008",$maxlv, )
//		endif
//		
////------------------------------------------------------------------------
//		//---------????????
////		if $week != 6
////			if $week != 0
////				BC( "dialogbox" , "player" , -1 , "GUID:04770000009" )
////				return
////			endif
////		endif
////------------------------------------------------------------------------
...
//		if $sum == 0
//
//			BC( "dialogbox" , "player" , -1 , "GUID:04770000012" )
//			return
//		endif
////------------------------------------------------------------------------
//		if $down != 0
...
////				BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000014" , $spreadupamount ," Salary" )
////				SetPlayerVar( -1 ,3964, $systime, )
//			BC( "dialogbox" , "player" , -1 , "GUID:04770000016" )
//			return
//		endif
...
//                       // BC( "chat" , "player" , -1 , "GUID:04770000017",$spreaddownamount,"GUID:04770000018",$weekamount,"GUID:04770000019",$spreadlv, )
//			
//		endif
////---------????
//		//---------????????
...
//		//---------???????????
//		$lastlv = GetPlayerVar(-1 , 3272) 
////		BC( "chat" , "player" , -1 , "GUID:04770000020",$spreadhave,"GUID:04770000021",$weekamount,"GUID:04770000022",$lastlv, )
//		//BC( "chat" , "player" , -1 , "GUID:04770000023",$spreadlv, )
//			
//
//			
//		    
...
////				AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////				AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////				BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000025" , $weekamount ,"GUID:04770000026"  , $spreadupamount , " Salary" )
//				BC( "dialogbox" , "player" , -1 , "GUID:04770000028" , $weekamount ,"GUID:04770000029" )
...
////						AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////						AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////						BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000031" , $spreadrest ,"GUID:04770000032" , $spreadupamount , "GUID:04770000033" )
//						BC( "dialogbox" , "player" , -1 , "GUID:04770000034" , $spreadrest ,"GUID:04770000035" )
...
////						AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////						AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////						BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000037" , $weekamount ,"GUID:04770000038" , $spreadupamount , " Salary" )
////						SetPlayerVar( -1 ,3819, $spreadhave, )
////						SetPlayerVar( -1 ,3964, $systime ,)
////						SetPlayerVar( -1 ,3971, $weekamount ,)
//						return
...
////					AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////					AddPlayerInfo( -1, "givepoint", $spreadupamount, )
//					BC( "dialogbox" , "player" , -1 , "GUID:04770000040" , $spreadrest  ,"GUID:04770000041" )
//					SetPlayerVar( -1 ,3819, $spreadhave, )
////					SetPlayerVar( -1 ,3964, $systime ,)
//					SetPlayerVar( -1 ,3272, $spreadlv ,)
//					return
...
////				AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////				AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////				BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000043" , $spread ,"GUID:04770000044", $spreadupamount , " Salary" )
//				BC( "dialogbox" , "player" , -1 , "GUID:04770000046" )
////				SetPlayerVar( -1 ,3964, $systime ,)
//				return
//			endif
//		else
...
////				AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////				AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////				BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000048" , $spreadrest ,"GUID:04770000049" , $spreadupamount , "GUID:04770000050" )
//				BC( "dialogbox" , "player" , -1 , "GUID:04770000051" , $spreadrest ,"GUID:04770000052" )
//				SetPlayerVar( -1 ,3819, $spreadhave, )
////				SetPlayerVar( -1 ,3964, $systime ,)
//				SetPlayerVar( -1 ,3272, $spreadlv ,)
//				SetPlayerVar( -1 ,3971, $weekamount ,)
...
////				AddPlayerInfo( -1, "givepoint", $mastergivepoint, )
////				AddPlayerInfo( -1, "givepoint", $spreadupamount, )
////				BC( "dialogbox" , "player" , -1 , "You have received gifts! Rewards for master: " , $mastergivepoint ,"GUID:04770000054" , $weekamount  ,"GUID:04770000055", $spreadupamount , " Salary"  )
////				SetPlayerVar( -1 ,3819, $spreadhave , )
////				SetPlayerVar( -1 ,3964, $systime ,)
////				SetPlayerVar( -1 ,3272, $spreadlv ,)
////				SetPlayerVar( -1 ,3971, $weekamount ,)
