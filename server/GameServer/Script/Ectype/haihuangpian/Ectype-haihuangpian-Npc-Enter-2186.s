	...
	function OnOption0(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000005" )
	...
	function OnOption1(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000014" )
	...
	function OnOption2(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000023" )
	...
	function OnOption3(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000032" )
	...
	function OnOption4(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000041" )
	...
	function OnOption5(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000050" )
	...
	function OnOption6(){
		...
		if $mapcount < 300
			//BC( "screen", "player", -1, "GUID:04582000059" )
