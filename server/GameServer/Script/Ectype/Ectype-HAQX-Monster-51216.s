	...
	//		Modified:2009/07/25
	//		Author: ??
	//		TaskName:Ectype-HAQX-Monster-51216.s
	//		TaskID:??
	//****************************************
	...
	function OnDead(){
		...
		if $ectype_ID > 0
			...
			AddNPC(1969, $ectype_ID)
			AddNPC(2019, $ectype_ID)
			BC("screen", "map", $ectype_ID, "The Northern Requiem Pillar appears! Destroy it as soon as you can!")
