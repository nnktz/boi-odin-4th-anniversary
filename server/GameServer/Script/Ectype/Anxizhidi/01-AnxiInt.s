...
//		BC( "screen" , "map" , $ectype_id , "GUID:03853000000" , $ectype_id )
	}
...
BC("screen","map",$ectype_id,"The monsters have stopped appearing.")
		...
		if $count < $cmax		
			if $door1 == 0
				...
				$key = 2
				SetEctypeVar($ectype_id,$key,$count)
//BC("screen","map",$ectype_id,"GUID:03853000002")
			endif
		endif
		if $count < $cmax		
			if $door2 == 0
				...
				$key = 2
				SetEctypeVar($ectype_id,$key,$count)
//BC("screen","map",$ectype_id,"GUID:03853000003")
			endif
		endif
		
//BC("screen","map",$ectype_id,"GUID:03853000004",$count," | ",$cmax," | ",$door1," | ",$door2)
		StartEctypeTimer($ectype_id,2)
