...
//BC("screen","player",-1,"time = ",$time)
			if $time < 2100
//				BC("dialogbox","player",-1,"GUID:03949000003")
				return
			endif
			if $time < 2120
//------?????????????process??,??????
...
//			$randombuff = RandomNumber(0,1)
			$randombuff = 0
			if $randombuff == 0
				SendMail($playerid,"Successfully registered for the Throne of Boreas events.","Your guild has registered for the Throne of Boreas Event, at {#ffff0f0f=21:00#} on that day gather your guild to participate. \nYou can use {#ffff0f0f=once#} Summon Guild Members function. \nItem Control Key: a control panel used for handling the Zephyr. \n{#ff0fff0f=Realm: 3 (Please inform your guild!) #}",0,44387)
				...
				SendMail($playerid,"Successfully registered for the Throne of Boreas events.","Your guild has registered for the Throne of Boreas Event, at {#ffff0f0f=21:00#} on that day gather your guild to participate. \nYou can use {#ffff0f0f=once#} Summon Guild Members function. \nItem Control Key: a control panel used for handling the Zephyr. \n{#ff0fff0f=Realm: 5 (Please inform your guild!) #}",0,44387)
			...
			BC("messagebox","player",$playerid,"Your Guild has registered for the Throne of Boreas events. Make sure you gather everyone to participate tonight at 20:00!")
...
//$time = GetPlayerVar(-1,4070)
			if $time < 2100
				BC("dialogbox","player",-1,"You cannot board The Zephyr until 21:00!")
				return
			endif
			if $time >= 2120
...
//			BC("dialogbox","player",-1,"GUID:03949000045"$process)
...
//$time = GetPlayerVar(-1,4070)
			if $time < 2125
				BC("dialogbox","player",-1,"Eurus' Wasteland event hasn't started yet. Come back at 21:25!")
				return
			endif
			//------?????????
			$globalvar = GetGlobalVar(137)
...
//			BC("dialogbox","player",-1,"GUID:03949000059"$process)
			BC("dialogbox","player",-1,"Cannot board The Zephyr right now. Please try again!")
