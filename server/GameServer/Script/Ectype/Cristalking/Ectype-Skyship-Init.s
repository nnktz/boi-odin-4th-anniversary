...
//??:11 & 12
		...
		if $getvar == 0
			...
			//----------------------------------
//			BC("screen","map",$ectype_id,"GUID:03926000000",$count)
			StartEctypeTimer($ectype_id,1)
			...
			//----------------------------------count = 4
			if $count == 4
//			BC("screen","map",$ectype_id,"GUID:03926000001",$count)
				$rank_A = 21
				$rank_B = 21
				$key = 301
				while $key <= 320
	...
	//				BC("messagebox","map",$ectype_id,"GUID:03926000006",#gnamewin,"GUID:03926000007",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
	//				BC("chat","map",$ectype_id,"GUID:03926000009",#gnamewin,"GUID:03926000010",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
					return
				endif
				if $point_B > $point_A
					...
					BC("messagebox","map",$ectype_id,"The Zephyr has landed! The victor of this match is ",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
					BC("chat","map",$ectype_id,"The Zephyr has landed! The victor of this match is ",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
	//				BC("messagebox","map",$ectype_id,"GUID:03926000016",#gnamewin,"GUID:03926000017",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
	//				BC("chat","map",$ectype_id,"GUID:03926000019",#gnamewin,"GUID:03926000020",#gname,". The top 8 Guilds are qualified to take part in Eurus' Wasteland.")
					return
				endif
			endif
			//----------------------------------count = 3
			if $count == 3
//			BC("screen","map",$ectype_id,"GUID:03926000022",$count)
				$count = 4
				if $point_A > 0
					$guildid = $guildid_A
					$point = $point_A
			...
			//----------------------------------count = 1/2
			if $count < 3
//			BC("screen","map",$ectype_id,"GUID:03926000023",$count)
				$count = 3
				if $point_B > 0
					$guildid = $guildid_B
					$point = $point_B
