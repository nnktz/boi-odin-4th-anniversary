...
//		BC("screen","map",$ectype_id,"GUID:04564000000")
//		BC("chat","map",$ectype_id,"GUID:04564000001")
...
//		BC( "screen", "map",$ectype_id, "GUID:04564000002"$time )
	...
	//???5??,?? ??SS??????? SS ? S????,??????????????? ; ?? normal ???? ????????
		...
		$mon2_1_2 = 52315				
		$time = GetEctypeVar(-1,96)
//		BC( "screen", "map",$ectype_id, "GUID:04564000013"$time )
	...
	//???5??,?? ??SS??????? SS ? S????,??????????????? ; ?? normal ???? ????????
		...
		$mon2_1_2 = 52315				
		$time = GetEctypeVar(-1,96)
//		BC( "screen", "map",$ectype_id, "GUID:04564000024"$time )
