...
//		BC("screen","map",$ectype_id,"GUID:04540000000")
//		BC("chat","player",-1,"GUID:04540000001")
...
//						BC("screen","map",$ectype_id,"GUID:04540000002",$count,"GUID:04540000003")
//?10????????????
    				if $count == 22
  						SetEctypeVar(-1, 98, 0)
  						if $is_north > 0
...
//						  BC("screen","map",$ectype_id, "GUID:04540000011",#name)
  					endif
					endif
				endif
			endif
...
//??2?????????,5?
		if $is_summon_2 > 0
			...
			if $count > 11
//				BC("screen","map",$ectype_id,"GUID:04540000012")
				return
			else
				if $is_kill < 1
//					BC("screen","map",$ectype_id,"GUID:04540000013")					
					return
				else
					$count = $count + 1
					SetEctypeVar(-1, 98, $count)
					StartEctypeTimer(-1, 1)
//					BC("screen","map",$ectype_id,"GUID:04540000014",$count,"GUID:04540000015")
					if $is_north > 0
						if $is_south > 0
							SetEctypeVar(-1, 97, 1)
						endif
...
//			BC("screen","map",$ectype_id,"GUID:04540000018",$time,"GUID:04540000019")
...
//		BC("screen","map",$ectype_id,"GUID:04540000020")
...
//					BC("screen","map",$ectype_id,"GUID:04540000022")				
...
//    			SetEctypeVar(-1, 2, 1)
	...
	$ectype_id = GetEctypeID( -1 , 532 )	
//	BC("screen","map",$ectype_id,"GUID:04540000027")
...
//	BC("screen","map",$ectype_id,"GUID:04540000031")
	
	if $n == 2
		DeleteMonster($ectype_id,	$monster1)
//		BC("screen","map",$ectype_id,"GUID:04540000032")
	endif
	
	
	if $n == 3
		DeleteMonster($ectype_id, $monster2)
//		BC("screen","map",$ectype_id,"GUID:04540000033")
	endif

	if $n == 4
		DeleteMonster($ectype_id, $monster3)
//		BC("screen","map",$ectype_id,"GUID:04540000034")
	endif

	if $n == 5
		DeleteMonster($ectype_id, $monster4)
//		BC("screen","map",$ectype_id,"GUID:04540000035")
	endif
