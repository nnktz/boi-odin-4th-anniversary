	...
	//		Modified:2009/07/22
	//		Author:???
	//		TaskName:Ectype-Pyramid-Npc-1988.s
	//		TaskID:???
	//
	//****************************************
	//
	function OnRequest(){
		...
		$ectype_type0 = GetEctypeVar( -1, 0 )
		if $ectype_type0 == 1
			DisableNpcOption(0)
		endif
		
		$ectype_type = GetEctypeVar( -1, 3 )
		if $ectype_type != 1
...
//		//????????
//		if $team_count < 3
//			BC( "dialogbox", "player", -1, "GUID:04349000004" )
//			return
//		endif
		...
		FlyToMap( $teamplayer1_id, $ectype_ID, 51, 61 )
		FlyToMap( $teamplayer2_id, $ectype_ID, 51, 61 )
		FlyToMap( $teamplayer3_id, $ectype_ID, 51, 61 )
		FlyToMap( $teamplayer4_id, $ectype_ID, 51, 61 )
		FlyToMap( $teamplayer5_id, $ectype_ID, 51, 61 )
		FlyToMap( $teamplayer6_id, $ectype_ID, 51, 61 )
		SetEctypeVar( -1, 3, 1 )
