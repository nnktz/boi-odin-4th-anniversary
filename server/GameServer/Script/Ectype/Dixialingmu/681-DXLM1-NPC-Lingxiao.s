	...
	function OnOption0(){
		...
		$ectype_id = GetEctypeID(-1, 478)
			...
			//??
//		if $is_51821 == 1
//			BC( "screen", "player", -1,"GUID:04101000001")
//			return
//		endif
...
//		AddMonsterByFloat(51821, 1, $ectype_id, 268, 186, 0)
		...
		AddMonsterByFloat(51822, 1, $ectype_id, 270, 172, 0)
		
		BC( "screen", "map", $ectype_id, "Okay, let's go! Help me get rid of these spiders!")
		SetEctypeVar(-1, 91, 1)
