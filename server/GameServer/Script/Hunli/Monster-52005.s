	...
	function OnDead(){
		...
		if $count < 180
			//if $count == 50
			//	BC( "screen", "map", 208, "GUID:04849000012" )
			//endif
			//???1???1
			//BC( "screen", "map", 208, "GUID:04849000013" , $count , "GUID:04849000014" )
			$result = AddMonster(52005, 1, 208, 64, 66, 10 )
		
		//????180???????????1?,?1???2
		else
			//BC( "screen", "map", 208, "GUID:04849000015" , $count , "GUID:04849000016" )
			//if $count == 180
			//	//???10??????1000????,????????
			...
			//		AddLoveExp($id2, 1000)
			//	endif
			//	BC( "screen", "map", 208, "GUID:04849000017" )
			//endif
