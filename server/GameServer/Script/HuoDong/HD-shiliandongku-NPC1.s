	...
	//?????8??10???,?????12??2???
		...
		//??????????
		if $foul_player > 0
			//BC( "chat", "player", -1, "GUID:05450000012" )
			return
		endif
		...
		if $teamplayer1_id != -1
			...
			//????
			//BC( "chat", "player", -1, "GUID:05450000014",$temp_level,"GUID:05450000015",$total_level)
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000016",$temp_level,"GUID:05450000017",$total_level)
		endif
		if $teamplayer2_id != -1
			...
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000019",$temp_level,"GUID:05450000020",$total_level)
		endif
		if $teamplayer3_id != -1
			...
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000022",$temp_level,"GUID:05450000023",$total_level)
		endif
		if $teamplayer4_id != -1
			...
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000025",$temp_level,"GUID:05450000026",$total_level)
		endif
		if $teamplayer5_id != -1
			...
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000028",$temp_level,"GUID:05450000029",$total_level)
		endif
		if $teamplayer6_id != -1
			...
			$total_level += $temp_level
			//BC( "chat", "player", -1, "GUID:05450000031",$temp_level,"GUID:05450000032",$total_level)
		endif
		...
		if $teamplayer1_id != -1
			...
			//BC( "chat", "player", -1, "GUID:05450000034" )
			//????????
			if $result == 0
				//????
