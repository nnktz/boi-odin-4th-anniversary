...
//??????
	function OnOption0(){
		...
		//???90????,???????????????
		//if $level >= 90
		//	BC( "dialogbox", "player", -1, "GUID:05222000002" )
		//	return
		//endif
		...
		if $level < 50
			...
			//BC( "messagebox", "player", -1, "GUID:05222000006" )
		...
		if $level < 60
			...
			//BC( "messagebox", "player", -1, "GUID:05222000008" )
			SetPlayerVar( -1 , 3607, $today_time)
			return
		endif
		if $level < 70
			...
			//BC( "messagebox", "player", -1, "GUID:05222000010" )
			SetPlayerVar( -1 , 3607, $today_time)
			return
		endif
		if $level < 80
			...
			//BC( "messagebox", "player", -1, "GUID:05222000012" )
			SetPlayerVar( -1 , 3607, $today_time)
			return
		endif
		if $level < 90
			...
			//BC( "messagebox", "player", -1, "GUID:05222000014" )
			SetPlayerVar( -1 , 3607, $today_time)
			return
		endif
