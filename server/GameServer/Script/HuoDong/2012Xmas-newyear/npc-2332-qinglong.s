...
//???????!
	function OnOption3(){ 
		...
		if $totalitem > 10000
			BC("chat","player",-1,"You can use at most 10,000 Lucky Jades at once!")
			$totalitem = 10000
		endif
		$max = $totalitem
		call batting()
...
//					BC("chat","player",-1,"GUID:05007000040")
				endif
			endif
		endif
	//-----------????end----------------------
