...
--					print("GUID:04995000001"..randombuff)
--					AI:Say("GUID:04995000002"..randombuff)
					sayshit_A(AI,randombuff)
				else
					randombuff=math.random(1,8)
					AI:AddSkill(2529,randombuff)
					AI:UseSkill(2529,randombuff)
--					print("GUID:04995000003"..randombuff)
--					AI:Say("GUID:04995000004"..randombuff)
	...
	function Event_ArriveSeekPos(nAI, MapID, PosX, PosY)
		...
		if (( PosX == 186) and ( PosY == 144 )) then
			...
			if isover == 1 then
				...
				AI:Say("The Whispers of Spring are here! They are the first!")
				AI:ScreenText("Whispers of Spring is the champion of the Happy Run Event!",2)
			else
				AI:Say("The Whispers of Spring are here! ")
			end
			AI:DelTimer(1)
			AI:DelTimer(2)
			AI:SelfMurder()
