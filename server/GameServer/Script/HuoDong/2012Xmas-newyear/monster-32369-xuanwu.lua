...
--					print("GUID:05000000001"..randombuff)
--					AI:Say("GUID:05000000002"..randombuff)
					sayshit_A(AI,randombuff)
				else
					randombuff=math.random(1,8)
					AI:AddSkill(2529,randombuff)
					AI:UseSkill(2529,randombuff)
--					print("GUID:05000000003"..randombuff)
--					AI:Say("GUID:05000000004"..randombuff)
	...
	function Event_ArriveSeekPos(nAI, MapID, PosX, PosY)
		...
		if (( PosX == 186) and ( PosY == 138 )) then
			...
			if isover == 1 then
				...
				AI:Say("Burning Sky is here! He is the first one!")
				AI:ScreenText("Burning Sky is the champion of the Happy Run Event!",2)
			else
				AI:Say("Burning Sky is here!")
			end
			AI:DelTimer(1)
			AI:DelTimer(2)
			AI:SelfMurder()
...
--127-186
	...
	function sayshit_A(AI,randombuff)
		...
		if issay == 1 then
			if randombuff >= 1 and randombuff <= 3 then
				AI:Say("Even jogging can win this race!")
			end
			if randombuff >= 4 and randombuff <= 6 then
				AI:Say("This is the magic of jogging!")
			end
			if randombuff >= 7 and randombuff <= 8 then
				AI:Say("You are not jogging properly!")
			end
		end
	...
	function sayshit_B(AI,randombuff)
		...
		if issay == 1 then
			...
			if randombuff >= 4 and randombuff <= 6 then
				AI:Say("I feel exhausted.")
			end
			if randombuff >= 7 and randombuff <= 8 then
				AI:Say("I should buy a new pair of shoes!")
			end
		end
