...
--					print("GUID:04999000001"..randombuff)
--					AI:Say("GUID:04999000002"..randombuff)
					sayshit_A(AI,randombuff)
				else
					randombuff=math.random(1,8)
					AI:AddSkill(2529,randombuff)
					AI:UseSkill(2529,randombuff)
--					print("GUID:04999000003"..randombuff)
--					AI:Say("GUID:04999000004"..randombuff)
