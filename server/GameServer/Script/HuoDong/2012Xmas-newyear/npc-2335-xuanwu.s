...
//360	??Z
//361	??X
			$sysbat = GetServerVar(361)
			$sysbat += $max
			SetServerVar(361,$sysbat)
		else
...
//					BC("chat","player",-1,"GUID:05010000039")
				endif
			endif
		endif
	//-----------????end----------------------
