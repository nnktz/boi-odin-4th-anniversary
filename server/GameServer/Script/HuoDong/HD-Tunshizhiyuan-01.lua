...
-----------------------------------------------------
    ...
    local AI = GetMonsterAI(nAI)
		...
		if nIndex == 3 then
			b = math.random(0,4)
			if b == 0 then
				AI:ScreenText("Achinoth: Hahaha! I am leaving Soulbound Caves!",1)
			end
			if b == 1 then
				AI:ScreenText("Achinoth: My strength has been awakened!",1)
			end
			if b == 2 then
				AI:ScreenText("Achinoth: You cannot defeat me!",1)
			end
			if b == 3 then
				AI:ScreenText("Achinoth: We'll just see who has the last laugh!",1)
			end
		...
		-----------------------------------------??start
		if nIndex == 4 then
			AI:ScreenText("Due to accident, Achinoth disappeared in Olympus suddenly!",1)
			AI:Exit()
		end
		-----------------------------------------??end
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		AI:ScreenText("Achinoth: Hmmm! Loki gives me Eternal life. I will be revived!",1)
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(4)
