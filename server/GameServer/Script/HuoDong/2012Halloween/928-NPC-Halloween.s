...
//???54272
	...
	if $TaskVar >= 1
		...
		AddPlayerInfo( -1, "item", 54272, 1 )
		SetPlayerVar( -1, 251, 1 )
   ...
   $TaskVar = $TaskVar1 + $TaskVar2   
    ...
    $TaskVar = $TaskVar + $TaskVar7
	 if $TaskVar < 7
		...
		BC( "dialogbox", "player", -1, "One of my sisters is a good friend of Siv. I think you can find her in the west of the Trade Square! " )
		return
		endif
		if $TaskVar == 7
