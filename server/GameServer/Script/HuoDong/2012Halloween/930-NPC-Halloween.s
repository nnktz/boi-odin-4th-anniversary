   ...
   $TaskVar = $TaskVar1 + $TaskVar2   
    ...
    $TaskVar = $TaskVar + $TaskVar7
	 if $TaskVar < 7
		...
		BC( "dialogbox", "player", -1, "One of my siblings is very good at hiding. You may try your luck around the Guild Manor." )
		return
		endif
		if $TaskVar == 7
