	...
	function OnUseItem(){
		...
		if $rand == 1
			//BC( "chat", "player", -1, "GUID:05650000000" )
		...
		if $rand == 2
			//BC( "chat", "player", -1, "GUID:05650000001" )
		...
		if $rand == 3
			//BC( "chat", "player", -1, "GUID:05650000002" )
		...
		if $rand == 4
			//BC( "chat", "player", -1, "GUID:05650000003" )
		...
		if $rand == 5
			//BC( "chat", "player", -1, "GUID:05650000004" )
		...
		if $rand == 6
			//BC( "chat", "player", -1, "GUID:05650000005" )
