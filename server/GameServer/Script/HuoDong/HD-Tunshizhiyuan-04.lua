...
-----------------------------------------------------
    ...
    local AI = GetMonsterAI(nAI)
		...
		if nIndex == 3 then
			b = math.random(0,4)
			if b == 0 then
				AI:ScreenText("Tainted Ocean Warrior: The world is full of cheaters!",1)
			end
			if b == 1 then
				AI:ScreenText("Tainted Ocean Warrior: Naive people, do you even know why you are fighting?",1)
			end
			if b == 2 then
				AI:ScreenText("Tainted Ocean Warrior:Strength, this is the real Power!",1)
			end
			if b == 3 then
				AI:ScreenText("Tainted Ocean Warrior: None can stop me!",1)
			end
		...
		-----------------------------------------??start
		if nIndex == 4 then
			AI:ScreenText("Due to accident, Tainted Ocean Warrior disappeared in Olympus suddenly!",1)
			AI:Exit()
		end
		-----------------------------------------??end
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		AI:ScreenText("Tainted Ocean Warrior: Hmmm! Loki gives me Eternal life. I will be revived!",1)
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(4)
