...
//			BC("screen" , "server" , -1 ,  "GUID:05644000000" , #name , "GUID:05644000001" )
//			BC("chat" , "server" , -1 ,  "GUID:05644000002" , #name , "GUID:05644000003" )
		else
			if $rund > 5
	...
	//(lv^2+0.6*lv+1000)*30
				...
				//#name = GetPlayerInfo( -1 , "name" )
				//BC("screen" , "server" , -1 ,  "GUID:05644000007" , #name , "GUID:05644000008" )
				//BC("chat" , "server" , -1 ,  "GUID:05644000009" , #name , "GUID:05644000010" )
				//PlayEffect( -1 , "common\marry\quest\tx_quest_quanxin.ini" , 1 )
			endif
		endif
	}