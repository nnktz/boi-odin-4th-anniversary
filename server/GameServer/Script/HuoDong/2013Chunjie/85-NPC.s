  ...
  if $Now_Mday < 10
   ...
   if $Now_Mday > 26
    ...
    if $playervar > 2
   	...
   	//??????
		$Info = GetPlayerInfo( -1, "item", 44637)	
			if $Info < 1
				DisableNpcOption(0)
