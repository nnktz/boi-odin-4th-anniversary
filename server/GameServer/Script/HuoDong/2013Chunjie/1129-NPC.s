...
//5????		59841
	...
	//	   if $playervar < $level14
	//	      #name = GetPlayerInfo( -1, "name" )
	//	     BC( "screen", "servergroup", -1, "Congratulations! Player ",#name,"GUID:05108000150")
	...
	//	   if $playervar < $level15
	//	      #name = GetPlayerInfo( -1, "name" )
	//	     BC( "screen", "servergroup", -1, "Congratulations! Player ",#name,"GUID:05108000154")
	...
	//	   if $playervar < $level16
	//	      #name = GetPlayerInfo( -1, "name" )
	//	     BC( "screen", "servergroup", -1, "Congratulations! Player ",#name,"GUID:05108000158")
	...
	//	   if $playervar < $level17
	//	      #name = GetPlayerInfo( -1, "name" )
	//	     BC( "screen", "servergroup", -1, "Congratulations! Player ",#name,"GUID:05108000162")
	...
	//	   if $playervar < $level18
	//	      #name = GetPlayerInfo( -1, "name" )
	//	     BC( "screen", "servergroup", -1, "Congratulations! Player ",#name,"GUID:05108000166")
