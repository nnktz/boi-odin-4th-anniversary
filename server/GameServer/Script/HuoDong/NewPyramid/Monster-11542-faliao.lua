...
--		//49	???-????	????? 576
	...
	function speakshit_A(nAI)
		...
		if randomnuff == 1 then
			AI:Say("Stupid Pharaoh thought he was immortal, but I am the Master here!")
		end
		if randomnuff == 2 then
			AI:Say("I am the Master of this Pyramid!")
		end
		if randomnuff == 3 then
			AI:Say("No one can escape my field.")
		end
		if randomnuff == 4 then
			AI:Say("Give up, impotent human.")
		end
	end
	...
	function speakshit_B(nAI)
		...
		if randomnuff == 2 then
			AI:Say("How could you fight against me? You are a nobody!")
		end
		if randomnuff == 3 then
			AI:Say("Haha. You see it. That's the Pharaoh's Strength.")
		end
		if randomnuff == 4 then
			AI:Say("It's not wise to disturb me!")
		end
	end
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		status=AI:GetArray(1)
		if status == 1 then
			AI:ScreenText("Devilworm Falio is collecting energy as the Pharaoh Sanctuary appears.",2)
