...
--		//49	???-????	????? 576
	...
	function speakshit_A(nAI)
		...
		if randomnuff == 1 then
			AI:Say("Ah, visitors, I shall make runes from your blood!")
		end
		if randomnuff == 2 then
			AI:Say("Demons lurk in the dark, searching for foolish mortals!")
		end
		if randomnuff == 3 then
			AI:Say("You will experience unprecedented pain.")
		end
		if randomnuff == 4 then
			AI:Say("The most powerful Elven Mage is standing before you. How will you face your fears?")
		end
	end
	...
	function speakshit_B(nAI)
		...
		randomnuff = math.random(1,12)
		if randomnuff == 1 then
			AI:Say("Have the Earth freeze over! Soon the entire world will be covered in white.")
		end
		if randomnuff == 2 then
		...
		if randomnuff == 3 then
			AI:Say("Unyielding snow and bitter frost, gather before me! Destroy my enemies! Frost Force!")
		end
		if randomnuff == 4 then
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		status=AI:GetArray(1)
		if status == 1 then
			AI:ScreenText("Arch Heretic Britacesk is collecting energy as the Pharaoh Sanctuary appears.",2)
		...
		if status == 2 then
			AI:Say("My spell was not finished...")
			AI:ScreenText("Britacesk: My spell was not finished...",2)
		end
		AI:DelTimer(1)
		AI:DelTimer(2)
