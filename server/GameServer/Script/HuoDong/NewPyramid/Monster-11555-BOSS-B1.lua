...
------------------------------------------------------------------------thinking
	...
	function speakshit(nAI)
		...
		if randomnuff == 2 then
			AI:Say("Disgusting men, don't come near to me!")
		end
		if randomnuff == 3 then
			AI:Say("Curse you! I'll make sure to torment you slowly! ")
		end
	end
...
------------------------------------------------------------------------dead
	...
	function SummonServerMonster(nAI)
		...
		for a=1,cmax do
			...
			MonsterID=math.random(11578,11583)
			if Flevel > 0 then
