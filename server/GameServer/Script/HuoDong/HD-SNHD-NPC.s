...
//		//????????
//		if $level < 20
//			BC( "dialogbox", "player", -1, "GUID:05457000000" )
//			return
//		endif
//		
//		$count = GetTaskCount ( -1 )
//		if $count >= 20
//			BC( "dialogbox", "player", -1, "GUID:05457000001" )	
//			return
//		endif
//		
//		//??????
...
//				call IsExistQuest()
//				if $ExistQuest == 1
//					BC( "dialogbox", "player", -1, "GUID:05457000002" )
//					return
//				else
//					if $Task1 > 4
//						BC( "dialogbox", "player", -1, "GUID:05457000003" )
//						return
//					else
//						$Task0 = 1
//						$Task1 = $Task1 + 1
...
//						SetPlayerVar( -1, 15, 1 )
//						BC( "dialogbox", "player", -1, "GUID:05457000004",$Task1,"GUID:05457000005",$Task0,"GUID:05457000006" )
//						return
//					endif
//				endif
//			else
//				if $Task0 > 5
//					if $Task1 > 5
//						BC( "dialogbox", "player", -1, "GUID:05457000007" )
//						return
//					else
//						$Task0 = 1
//						$Task1 = $Task1 + 1
...
//						SetPlayerVar( -1, 3218, $Task1 )
//						SetPlayerVar( -1, 15, 1 )
//						BC( "dialogbox", "player", -1, "GUID:05457000008",$Task1,"GUID:05457000009",$Task0,"GUID:05457000010" )
//						return
//					endif
//				else
//					call RandomQuest()
...
//					SetPlayerVar( -1, 15, 1 )
//					BC( "dialogbox", "player", -1, "GUID:05457000011",$Task1,"GUID:05457000012",$Task0,"GUID:05457000013" )
//					return	
//				endif
//			endif
//		else
...
//			BC( "dialogbox", "player", -1, "GUID:05457000014" )
//			return
//		endif
//	}
