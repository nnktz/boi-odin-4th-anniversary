	...
	//????????????ID
		...
		if $teamplayer1_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer1_id, "GUID:05469000004", $add_exp ,"GUID:05469000005",$add_money)
		...
		if $teamplayer2_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer2_id, "GUID:05469000006", $add_exp ,"GUID:05469000007",$add_money)
		...
		if $teamplayer3_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer3_id, "GUID:05469000008", $add_exp ,"GUID:05469000009",$add_money)
		...
		if $teamplayer4_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer4_id, "GUID:05469000010", $add_exp ,"GUID:05469000011",$add_money)
		...
		if $teamplayer5_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer5_id, "GUID:05469000012", $add_exp ,"GUID:05469000013",$add_money)
		...
		if $teamplayer6_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer6_id, "GUID:05469000014", $add_exp ,"GUID:05469000015",$add_money)
