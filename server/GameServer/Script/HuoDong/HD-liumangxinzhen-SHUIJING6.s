...
//						BC("chat", "player", $teamplayer1_id ,"GUID:05325000034")
//						BC("screen", "player", $teamplayer1_id ,"GUID:05325000035")
			...
			if $teamplayer2_id != -1
				if $n == 2
					...
					if $bag_count < 1
						...
						BC("screen", "servergroup", -1 ,"The hero ",#name," got the Musical Maestro Pet from the Hexagram event.")
//
//						BC("chat", "player", $teamplayer2_id ,"GUID:05325000044")
//						BC("screen", "player", $teamplayer2_id ,"GUID:05325000045")
...
//						BC("chat", "player", $teamplayer3_id ,"GUID:05325000054")
//						BC("screen", "player", $teamplayer3_id ,"GUID:05325000055")
...
//						BC("chat", "player", $teamplayer4_id ,"GUID:05325000064")
//						BC("screen", "player", $teamplayer4_id ,"GUID:05325000065")
...
//						BC("chat", "player", $teamplayer5_id ,"GUID:05325000074")
//						BC("screen", "player", $teamplayer5_id ,"GUID:05325000075")
...
//						BC("chat", "player", $teamplayer6_id ,"GUID:05325000084")
//						BC("screen", "player", $teamplayer6_id ,"GUID:05325000085")
