...
//		endif
	...
	function OnOption0(){
		...
		//if $n == 1
		//	AddStatus(-1 , 10516 , 1)
		//	BC("dialogbox", "player", -1, "GUID:08642000000")
		//endif
		//if $n == 2
		//	AddStatus(-1 , 10517 , 1)
		//	BC("dialogbox", "player", -1, "GUID:08642000001")
		//endif
		//if $n == 3
		//	AddStatus(-1 , 10518 , 1)
		//	BC("dialogbox", "player", -1, "GUID:08642000002")
		//endif
		if $n == 4
			AddStatus(-1 , 10519 , 1)
...
//		if $money < 100
//			BC( "dialogbox", "player", -1, "GUID:08642000043" )
//			return
//		endif
//??
...
//			BC( "chat", "player", -1, "GUID:08642000044" )
//			BC( "dialogbox", "player", -1, "GUID:08642000045" )
//		endif
		if $n == 1
			SetPlayerVar( -1, 3680 , 3 )
			BC( "chat", "player", -1, "I've already calibrated your probe. According to the new display on it, the treasure should be at Aegean North." )
...
//		if $PlayerVar == $day
//			BC( "dialogbox", "player", -1, "GUID:08642000055" )
//			return
//		endif
//		
...
//			SetPlayerVar( -1, 40, 0 )
//		else
//			BC( "dialogbox", "player", -1, "GUID:08642000056" )
//			return	
//		endif
//		
//	}
...
//		$level = GetPlayerInfo( -1, "level" )
//		if $level < 30
//			BC( "dialogbox", "player", -1, "GUID:08642000058" )
//			return
//		endif
//		
...
//		$day = GetSystemTime( "yday" )
//		if $PlayerVar == $day
//			BC( "dialogbox", "player", -1, "GUID:08642000059" )
//			return
//		endif
//		
//		AddPlayerInfo( -1, "item", 63442, 1 )
...
//	}	
		...
		function OnOption6(){
			...
			$Now_Month = GetSystemTime( "month" )
//			if $Now_Month < 8
//				BC( "dialogbox" , "player" , -1 , "GUID:08642000060" )
//				return
//			endif
//			
//			if $Now_Month == 8
//				if $Now_Mday < 10
//					BC( "dialogbox" , "player" , -1 , "GUID:08642000061" )
//					return
//				endif
//			endif
