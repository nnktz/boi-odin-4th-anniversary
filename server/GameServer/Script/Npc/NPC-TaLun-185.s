	...
	function OnOption0(){
		...
		$Item1 = GetPlayerInfo( -1, "item", 37061 )
		$Item2 = GetPlayerInfo( -1, "item", 37063 )
		$Item = $Item1 + $Item2
		if $Item < 1
			BC( "dialogbox", "player", -1, "Sorry! You don't have a VIP 15 Noble Fashion Ticket." )
			return
		endif
		
		if $Item1 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37061, 1 )
			if $SubItem != 0
				return 
			endif
			...
			//sex=0 ?;
			if $Sex == 0
				AddPlayerInfo( -1, "item", 37055, 1 )
			else
				AddPlayerInfo( -1, "item", 37056, 1 )
			endif
			return
		endif
		
		if $Item2 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37063, 1 )
			if $SubItem != 0
				return 
			endif
			...
			//sex=0 ?;
			if $Sex == 0
				AddPlayerInfo( -1, "item", 37058, 1 )
			else
				AddPlayerInfo( -1, "item", 37059, 1 )
			endif
	...
	function OnOption1(){
		...
		$Item1 = GetPlayerInfo( -1, "item", 37062 )
		$Item2 = GetPlayerInfo( -1, "item", 37064 )
		$Item = $Item1 + $Item2
		if $Item < 1
			BC( "dialogbox", "player", -1, "Sorry! You don't have a VIP 15 Noble Fashion Ticket." )
			return
		...
		if $Item1 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37062, 1 )
			if $SubItem != 0
				return 
			endif
		...
		if $Item2 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37064, 1 )
			if $SubItem != 0
				return 
			endif
		...
		$Item1 = GetPlayerInfo( -1, "item", 37046 )
		$Item2 = GetPlayerInfo( -1, "item", 37048 )
		$Item = $Item1 + $Item2
		if $Item < 1
			BC( "dialogbox", "player", -1, "Sorry! You don't have a VIP 14 Noble Fashion Ticket." )
			return
		endif
		
		if $Item1 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37046, 1 )
			if $SubItem != 0
				return 
			endif
			...
			//sex=0 ?;
			if $Sex == 0
				AddPlayerInfo( -1, "item", 37040, 1 )
			else
				AddPlayerInfo( -1, "item", 37041, 1 )
			endif
			return
		endif
		
		if $Item2 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37048, 1 )
			if $SubItem != 0
				return 
			endif
			...
			//sex=0 ?;
			if $Sex == 0
				AddPlayerInfo( -1, "item", 37043, 1 )
			else
				AddPlayerInfo( -1, "item", 37044, 1 )
			endif
			BC( "dialogbox", "player", -1, "Due to your status as a Platinum VIP, you received some Platinum fashion!" )
			return
		endif
	...
	function OnOption3(){
		...
		$Item1 = GetPlayerInfo( -1, "item", 37047 )
		$Item2 = GetPlayerInfo( -1, "item", 37049 )
		$Item = $Item1 + $Item2
		if $Item < 1
			BC( "dialogbox", "player", -1, "Sorry! You don't have a VIP 14 Noble Fashion Ticket." )
			return
		...
		if $Item1 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37047, 1 )
			if $SubItem != 0
				return 
			endif
		...
		if $Item2 > 0 
			$SubItem = SubPlayerInfo( -1, "item", 37049, 1 )
			if $SubItem != 0
				return 
			endif
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000031" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000033" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000035" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000037" )
//			return
//		endif
//		
...
//		//??????????
//		if $bag_count < 1
//			BC( "screen", "player", -1, "GUID:08656000038" )
//			return
//		endif
//		
//		$Item = GetPlayerInfo( -1, "item", 59363 )
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000039" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000041" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000043" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000045" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000047" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000049" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000051" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000053" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000055" )
//			return
//		endif
//		
...
//		if $Item < 1
//			BC( "dialogbox", "player", -1, "GUID:08656000057" )
//			return
//		endif
//		
