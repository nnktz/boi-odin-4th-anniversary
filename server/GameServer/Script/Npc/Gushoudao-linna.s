	...
	function OnOption0(){
		...
		if $line == 8
			...
			if $result1 == 0
				...
				if $result == 0 			 
					 //BC( "screen", "player", -1 , "GUID:08487000003")
				...
				if $result2 == 0
					$result = AcceptTask( -1, 1758 )
					if $result == 0 			 
						 //BC( "screen", "player", -1 , "GUID:08487000004")
						 FlyToMap( -1, 291, 106, 108 )
						 return				
					endif
				else
					...
					if $result3 == 0
						$result = AcceptTask( -1, 1758 )
						if $result == 0 			 
							 //BC( "screen", "player", -1 , "GUID:08487000005")
							 FlyToMap( -1, 291, 106, 108 )
							 return				
						endif	
					endif				
		...
		if $line == 7
			...
			if $result1 == 0
				$result = AcceptTask( -1, 1758 )
				if $result == 0 			 
					 //BC( "screen", "player", -1 , "GUID:08487000009")
					 FlyToMap( -1, 291, 106, 108 )
					 return				
				endif
			else
				...
				if $result2 == 0
					$result = AcceptTask( -1, 1758 )
					if $result == 0 			 
						 //BC( "screen", "player", -1 , "GUID:08487000010")
						 FlyToMap( -1, 291, 106, 108 )
						 return				
					endif
				else
					...
					if $result3 == 0
						$result = AcceptTask( -1, 1758 )
						if $result == 0 			 
							 //BC( "screen", "player", -1 , "GUID:08487000011")
							 FlyToMap( -1, 291, 106, 108 )
							 return				
						endif	
					endif				
...
//?????
	function OnOption1(){
		...
		if $line == 7
			$task = IsTaskAccept( -1, 1758 )
			if $task == 0
				 //BC( "screen", "player", -1 , "GUID:08487000013")
				 FlyToMap( -1, 291, 106, 108 )
				 return
			else
		...
		if $line == 8
			$task = IsTaskAccept( -1, 1758 )
			if $task == 0
				 //BC( "screen", "player", -1 , "GUID:08487000015")
				 FlyToMap( -1, 291, 106, 108 )
				 return
			else
				 BC( "dialogbox", "player", -1, "Cannot enter Ancient Beast Island.")
