...
//8???????5????????
	function OnOption2(){
		...
		$itemsub_ID_B = 59976
		#itemcardname = "N/A"
		#itemboxname = "Celestial Blessing Gift Pack"
		#itemsubname = "Welcoming Key"
		//??
		if $itemcardsub > 0
			$itemcard = GetPlayerInfo(-1,"item",$itemcard_id)
			if $itemcard < $itemcardsub
				BC("dialogbox","player",-1,"You don't have ",$itemcardsub,".",#itemcardname,"!")
				return
			endif
		endif
		if $itemsubmax > 0
			...
			if $itemtotal < $itemsubmax
				BC("dialogbox","player",-1,"Requirement ",$itemsubmax,".",#itemsubname,"to exchange.",$itemboxadd,".",#itemboxname,"Got it.")
				return
			endif
		endif
...
////	if $days == $today_days
////		BC("screen", "player", -1, "GUID:08635000018")
////		return
////	endif
//	
//	
...
//	if $liveness < 6000
//		BC("screen", "player", -1, "GUID:08635000019")
//		return
//	endif
//	
//	$a = 2100
...
//			BC("screen", "player", -1, "GUID:08635000020" ,$givepoint ,"GUID:08635000021")
//			SetPlayerVar(-1 , 3628 , $today_days)
//		else
//			AddPlayerInfo(-1 , "givepoint" , $givepoint)
//			BC("screen", "player", -1, "GUID:08635000022" ,$givepoint ,"GUID:08635000023")
//			SetPlayerVar(-1 , 3628 , $today_days)
//			
//		endif
//		//??-START
...
//	
//	if $Now_Year != 2009
//		BC("dialogbox", "player", -1, "GUID:08635000024")
//		return
//	endif
//	if $Now_Month != 6
//		BC("dialogbox", "player", -1, "GUID:08635000025")
//		return
//	endif
//	
//	if $Now_Mday < 6
//		BC("dialogbox", "player", -1, "GUID:08635000026")
//		return
//	endif
//	if $Now_Mday > 12
//		BC("dialogbox", "player", -1, "GUID:08635000027")
//		return
//	endif
//	
//	$huoyuedu = GetPlayerInfo(-1 ,"prestige" , 38)
//	if $huoyuedu < 3600
//		BC("dialogbox", "player", -1, "GUID:08635000028")
//		return
//	endif
//	
//	$today_days = GetSystemTime( "yday" )
...
//	$days = GetPlayerVar(-1 , 3677)
//	if $days == $today_days
//		BC("screen", "player", -1, "GUID:08635000029")
//		return
//	endif
//	
//	//?????????,??7??,?????
...
//	if $get_number >= 7
//		BC("screen", "player", -1, "GUID:08635000030")
//		return
//	endif
//	
//	
...
//	
//	AddPlayerInfo(-1 , "givepoint" , $givepoint)
//	BC("screen", "player", -1, "GUID:08635000031",$double,"GUID:08635000032" ,$givepoint ,"GUID:08635000033")
