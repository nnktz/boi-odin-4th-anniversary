	...
	function OnOption0(){
		...
		//if $n == 1
		//	AddStatus(-1 , 10516 , 1)
		//	BC("dialogbox", "player", -1, "GUID:08676000000")
		//endif
		//if $n == 2
		//	AddStatus(-1 , 10517 , 1)
		//	BC("dialogbox", "player", -1, "GUID:08676000001")
		//endif
		if $n == 3
			AddStatus(-1 , 10518 , 1)
...
//		if $money < 100
//			BC( "dialogbox", "player", -1, "GUID:08676000027" )
//			return
//		endif
//??
...
//		if $PlayerVar == $day
//			BC( "dialogbox", "player", -1, "GUID:08676000039" )
//			return
//		endif
//		
...
//			SetPlayerVar( -1, 40, 0 )
//		else
//			BC( "dialogbox", "player", -1, "GUID:08676000040" )
//			return	
//		endif
//		
//	}
...
//		$level = GetPlayerInfo( -1, "level" )
//		if $level < 30
//			BC( "dialogbox", "player", -1, "GUID:08676000042" )
//			return
//		endif
//		
...
//		$day = GetSystemTime( "yday" )
//		if $PlayerVar == $day
//			BC( "dialogbox", "player", -1, "GUID:08676000043" )
//			return
//		endif
//		
//		AddPlayerInfo( -1, "item", 63442, 1 )
