...
//	----------------------------------------------------
	...
	function OnDead(){
		...
		BC( "chat", "server", -1, "Player:",#player_name,"I led a party to kill Arch Priest Britacesk. The Hexagram Array Trap and the Seal to the Palace of Osiris has been removed." )
		BC( "screen", "server", -1, "Player:",#player_name,"I led a party to kill Arch Priest Britacesk. The Hexagram Array Trap and the Seal to the Palace of Osiris has been removed."  )
