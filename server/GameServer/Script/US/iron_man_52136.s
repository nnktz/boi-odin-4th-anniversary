	...
	function OnUseItem(){
		...
		if $del_count == 0
			...
			if $random_item_2 <= 2
				...
				BC("screen", "servergroup", -1, "Player: ",#name," opened the Man of Iron's Safe, and was lucky enough to receive a Stardust Coin!" )
				BC("chat", "servergroup", -1, "Player: ",#name," opened the Man of Iron's Safe, and was lucky enough to receive a Stardust Coin!" )
			endif
			...
			if $random_item_2 > 2
				if $random_item_2 <= 3
					...
					#name = GetPlayerInfo(-1 , "name")
					BC("screen", "servergroup", -1, "Player: ",#name," opened the Man of Iron's Safe, and was lucky enough to receive a Man of Iron mount!" )
					BC("chat", "servergroup", -1, "Player: ",#name," opened the Man of Iron's Safe, and was lucky enough to receive a Man of Iron mount!" )
				endif
			endif
