...
function OnOption0(){
			...
			if $n1 == 200000
					BC("scrollbar", "server", -1 , "With your efforts, the second snowman is made. Please go to get your gift")
					$n1 = $n1 + 1
					SetGlobalVar( 202,$n1 )
					DeleteNPC( 9012 )
					DeleteNPC( 9020 )
...
function OnOption1(){
			...
			if $a < 2
					BC( "dialogbox", "player", -1, "Just give me two Blessed Snowballs and you can get a gift" )
					return
			endif
			...
			$sub = SubPlayerInfo(-1,"item",52116,2)


			AddPlayerInfo( -1, "item", 52122, 1 )
			BC( "dialogbox", "player", -1, "Merry Christmas" )
			SetPlayerVar( -1, 3852, $t1 )
