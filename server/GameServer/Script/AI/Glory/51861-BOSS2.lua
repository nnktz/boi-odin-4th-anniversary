	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			...
			if a == 1 then
				...
				AI:SetArray(1,2)
				AI:SetArray(9,1)
				AI:Say("Hrmph. Only a few mortals. ")
			end
		end
...
--						AI:ScreenText("",2)
						AI:Say("Yes, sleep will make it all better. ")
					else
						if rand < 66 then
--							AI:ScreenText("",2)
...
--						AI:ScreenText("",2)
						AI:Say("Show me what you mortals are made of!")
					else
						if rand < 66 then
--							AI:ScreenText("",2)
								AI:Say("I may have underestimated you. ")
						else
--							AI:ScreenText("",2)
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		AI:ScreenText("What the... This isn't happening! ",2)
