...
--				AI:GetRandTarget()
				...
				AI:ScreenText("Darknight Rose: What!? Someone has dared to disturb my tea party?",2)
			end
			if a == 6 then
				AI:Say("I suppose black tea flavored with your defeat will be tastier! ")
				AI:ScreenText("Darknight Rose: my tea accompanied with your bloody defeat will be so refreshing. ",2)
			end
			if a == 11 then
				AI:Say("Let's play a game! ")
		...
		if nIndex == 3 then--????
			AI:AddSkill(2163,1)
			AI:UseSkill(2163,1)
			AI:Say("Oh, you have really made me mad, now! ")
		end--????end
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		AI:Say("Dear sister, please forgive me. ")
		AI:ScreenText("Darknight Rose: Sister, please, forgive me.",2)
