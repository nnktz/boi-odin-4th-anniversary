...
-----------------------------------------------------
	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			a = AI:GetArray(1)
			if a == 1 then
					AI:Say("I've been sealed up for much too long.")
			end
			AI:SetArray(1,2)
			AI:SetArray(9,1)
		end--??????
...
--								AI:ScreenText("",2)
								AI:Say("You will bow to my power. ")
							end
						end--??2??--end
					end--??2--end
				end--??all--end
	...
	function Event_Thinking(nAI)
		...
		-----------------------------------------------------------normal start
			...
			if a == 0 then --?????,????,????
				...
				AI:SetArray(1,1)
		    AI:SetArray(9,0)
				AI:Say("Who has disturbed the Magic Guardian?")
			end
			a = AI:GetArray(2)
			if a == 0 then --????,????
