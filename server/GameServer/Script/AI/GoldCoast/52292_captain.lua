...
------------------------------------------------------------------------??????
		if nIndex == 1 then--????
			...
			if a == 1 then
					AI:UpdateSeekPath(1)
					AI:Say("Captain Hatha: There are so many sea monsters. I need to hide quickly.")
					AI:ScreenText("The pirate captain sadly looked at his pirate ship broken in half. ",2)
					AI:SetArray(1,2)
			end
			if a == 2 then
					AI:ScreenText("Pirate Captain: I swear, I could smell the treasure in the air.",2)
					AI:SetArray(1,3)
			end
			if a == 3 then
					AI:ScreenText("Pirate Captain: No way, the sea monsters have not been wiped out. Look here, there are so many!",2)
					AI:SetArray(1,4)
			end			
...
------------------------------------------------------------------------dead
	...
	function Event_ArriveSeekPos(nAI, MapID, PosX, PosY)
		...
		if (( PosX == 161) and ( PosY == 182 )) then	
			if a == 1 then
				AI:Say("I'll leave now. After you take care of these monsters, come see me. ")
				AI:AddNPC( 784 )
				AI:SetArray(2,2)	
				AI:Exit()
			end
