...
-----------------------------------------------------
	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			...
			if a == 1 then
					AI:Say("You will not escape the blustery sea! ")
			end
			AI:SetArray(1,2)
			AI:SetArray(9,1)
		end--??????
		...
		if nIndex == 4 then--??????
			...
			if a == 0 then
				if b == 1 then--?????
					AI:ChangeFaction(11)
					AI:UpdateSeekPath(1)
					AI:ScreenText( "Elite Naga Warrior: So, you weak, little humans want our help? Hah! Not in this life!" , 2)
					AI:SetArray(4,1)
					AI:DelTimer(4)
				end
			end
...
------------------------------------------------------------------------thinking
	function Event_Thinking(nAI)
		...
		-----------------------------------------------------------normal start
		    ...
		    AI:ScreenText( "Elite Naga Warrior: Who dares to challenge the ocean's awesome power?" , 2)
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		--AI:ScreenText("",2)
		AI:Say("No... you have defeated me! ")
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(9)
