...
--				  AI:Say("I will feed on this power! ")				  
		...
		if nIndex == 3 then--????
				...
				AI:UseSkill(2337,2)
--				AI:ScreenText( "" , 2)
				AI:Say("My lightning will scorch and burn your skin! ")
		end--????end
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		AI:ScreenText("Kaltim: I was captured while searching for the truth, but now, I am finally free again. Thank you.",2)
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(9)
