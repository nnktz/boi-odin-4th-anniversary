...
-----------------------------------------------------
	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			...
			if a == 1 then
					AI:UpdateSeekPath(1)
					AI:Say("I am not sure why, but I am getting a bad feeling...")
	...
	function Event_Thinking(nAI)
		...
		-----------------------------------------------------------normal start
			...
			if a == 0 then --?????,????,????
				...
				AI:ChangeFaction(11)
		    AI:SetArray(9,0)
				AI:Say("It's incredible! This gang of pirates is much more powerful than we have ever seen. ")
			end
			a = AI:GetArray(2)
			if a == 1 then --????,????
...
------------------------------------------------------------------------dead
	function Event_OnDead(nAI)
		...
		--AI:ScreenText("",2)
		AI:Say("Before I die, I want to look at the sea again... and my beloved crab girl! ")
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(9)
