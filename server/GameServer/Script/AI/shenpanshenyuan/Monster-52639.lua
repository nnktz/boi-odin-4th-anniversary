    ...
    function Event_Thinking(nAI)
        ...
        if v == false then
            ...
            if a == 0 then
                if HP < HPMAX then
                    AI:Say("At last, I am free from the Pharaoh's grasp! As a gift, I shall bury you in eternal darkness!") 
                    AI:SetTimer(0,20000,1)
                    AI:SetTimer(2,61000,65535)
                    AI:SetTimer(4,40000,65535)
                    AI:SetTimer(6,40000,65535)
                    AI:SetTimer(7,4000,65535)
                    AI:SetArray(1,1)  
                end
            end
            if a == 1 then
