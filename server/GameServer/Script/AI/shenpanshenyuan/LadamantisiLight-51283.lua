...
--  Author: ???
--  Class: Lua
--  File Name: LadamantisiLight-51283.lua
--  Remarks: ???????
  	...
  	dark = AI:GetArray(3)
        ...
        --????
            if dark < 0 then
            	...
            	if d < 40 then
                	--????10??????? 
                	AI:ScreenText("Brightness and darkness are too close, accept our punishment.",1)
                	AI:Say("Accept our punishment.")
                	AI:AddSkill(8729,6)
                	AI:UseSkill(8729,6)
            	end
            	if d > 120 then
                	--????30??????? 
                	AI:ScreenText("Brightness and darkness are too far, accept our punishment.",1)
                	AI:Say("Accept our punishment.")
                	AI:AddSkill(8729,6)
                	AI:UseSkill(8729,6)
            	end
        ...
        if nIndex == 2 then
            if dark < 0 then
            	...
            	if d < 40 then
                	--????10??????? 
                	AI:ScreenText("Brightness and darkness are too close, if you do not separate them, you will be hurt by Dribble Trial.",1)
            	end
            	if d > 120 then
                	--????30??????? 
                	AI:ScreenText("Brightness and darkness are too far, if you do not separate them you will be hurt by Dribble Trial.",1)
            	end
            end
        end
