...
--            AI:ScreenText("GUID:03211000002",1)
--        end
        if nIndex == 2 then
        --?????? 
            AI:Say("Rush!")
    ...
    if t == false then
        ...
        if a == 1 then
            if HP < HPMAX * 0.8 then
                AI:Say("Let me show you my true colors. You won't feel pity!")
                AI:ScreenText("The Agony Source recovered its body!",1)
                --?? 
                AI:AddSkill(8887,4)
                AI:UseSkill(8887,4)
...
--                y = AI:GetPlayerY(id)
--                AI:SummonMonsterByPos(51312,x,y)
--                AI:ScreenText("GUID:03211000009",1)
        ...
        if a == 5 then
            if HP < HPMAX * 0.2 then
                ...
                AI:ScreenText("The Agony Source is in a frenzy!",1)
                --??
                AI:AddSkill(8871,12)
                AI:UseSkill(8871,12)
                AI:SetArray(1,6)
