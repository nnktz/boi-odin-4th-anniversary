...
--            	if d < 40 then
--                	--????10??????? 
--                	AI:ScreenText("GUID:03208000001",1)
--                	AI:Say("GUID:03208000002")
--                	AI:AddSkill(8729,6)
--                	AI:UseSkill(8729,6)
--            	end
--            	if d > 120 then
--                	--????30??????? 
--                	AI:ScreenText("GUID:03208000003",1)
--                	AI:Say("GUID:03208000004")
--                	AI:AddSkill(8729,6)
--                	AI:UseSkill(8729,6)
--            	end
--            end
...
--            	if d < 40 then
--                	--????10??????? 
--                	AI:ScreenText("GUID:03208000005",1)
--            	end
--            	if d > 120 then
--                	--????30??????? 
--                	AI:ScreenText("GUID:03208000006",1)
--            	end
--            end
--        end
