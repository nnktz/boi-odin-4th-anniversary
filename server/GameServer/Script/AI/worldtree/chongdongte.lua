function Event_OnTimer(nAI, nIndex, nCount)
    ...
    if nIndex == 4 then
    	AI:Say("Nidhogg springs from the Wormhole!")	
			Level=AI:GetEctypeVarInteger(mapid,110)
			pox,poy=161,169
			AI:SummonLevelMonsterByPos(51401,46,Level,pox,poy)
    	AI:SelfMurder()
    end  
end
