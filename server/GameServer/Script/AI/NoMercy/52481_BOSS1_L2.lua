...
-----------------------------------------------------
	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			a = AI:GetArray(1)
			if a == 1 then
					AI:Say("These waters will drown you!")				
			end
			AI:SetArray(1,2)
			AI:SetArray(9,1)			
		end--??????
		...
		if nIndex == 2 then--????
			...
			if a == 1 then--????
				...
				if talk < 30 then
					AI:Say("Will you choose to be drowned or eaten?")
				elseif talk < 60 then
					AI:Say("I eat anyone who passes me, piece by piece, bit by bit.")
				else
					AI:Say("I am Scylla, the master of these waters!")
				end
		...
		if nIndex == 3 then--????
				...
				AI:AddSkill(2530,5)
				AI:UseSkill(2530,5)	
				AI:ScreenText( "I am the master of these waters! I shall make even Poseidon tremble." , 2)
		end--????end
...
--				AI:UseSkill(2334,3)
				...
				if screen < 30 then
					AI:ScreenText( "Scylla: These waters are mine, they shall heal me." , 2)
				elseif screen < 60 then
				else
					AI:ScreenText( "Scylla: Time to harvest some souls!" , 2)
				end
		end--??1??end							
...
--	    		AI:ScreenText( "GUID:03079000007", 2 )    		
...
--	    		progress = AI:GetArray(3)
--	    		AI:SetEctypeVarShort(mapid,88,progress)
--	    		AI:ScreenText( "GUID:03079000008", 2 )
--					AI:SetEctypeVarInteger( mapid, 119, hplose )
--					AI:SetEctypeVarShort(mapid,83,1)--?BOSS????
--		      AI:SummonMonsterByPos(52380,216,80,180)
--		      AI:SummonMonsterByPos(52441,216,80,180)
...
--		-----------------------------------------------------------??BOSS??end				
		-----------------------------------------------------------normal start
			...
			if a == 0 then --?????,????,????
				...
				AI:SetArray(1,1)
		    AI:SetArray(9,0)
				AI:Say("Dare you pass these narrow waters to face me?")
			end
			a = AI:GetArray(2)
			if a == 0 then --????,????
...
--		end
	...
	function Event_OnDead(nAI)
		...
		--AI:ScreenText("",2)
		AI:Say("Raidne, I must return to the depths to heal my wounds!")
		AI:DelTimer(1)
		AI:DelTimer(2)
		AI:DelTimer(3)
		AI:DelTimer(4)
