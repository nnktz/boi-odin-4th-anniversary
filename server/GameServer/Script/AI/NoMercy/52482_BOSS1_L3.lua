...
--				AI:AddSkill(2383,3)
--				AI:UseSkill(2383,3)
--				AI:ScreenText( "GUID:03080000002" , 2)
--		end--????end
--		
--		if nIndex == 4 then--??1?? ??
...
--				AI:SummonMonsterByPos(52424,PosX + 1,b2, 1)				
----				AI:UseSkill(2334,3)
--				AI:ScreenText( "GUID:03080000003" , 2)
--		end--??1??end		
--		
--		if nIndex == 5 then--??3?? ??
--			local PosX = AI:GetPosX()
...
--						AI:SummonMonsterByPos(52425,PosX2,PosY2,1)												
--					end--for end
--					AI:ScreenText( "GUID:03080000004" , 2)
--		end--??2??end		
--
--		if nIndex == 6 then--??3?? ??
--				local PosX = AI:GetPosX()
...
--					AI:ScreenText("GUID:03080000005",1)
--					AI:SetArray(6,2)
--				end
--				if hinding == 2 then
--					a1 = PosX - 7
...
--					AI:ScreenText( "GUID:03080000006", 2)
--					AI:SetArray(6,0)
--					AI:Exit()
--				end			
--				
...
--	    		progress = AI:GetArray(3)
--	    		AI:SetEctypeVarShort(mapid,88,progress)
--	    		AI:ScreenText( "GUID:03080000007", 2 )    		
--					AI:SetEctypeVarInteger( mapid, 119, hplose )
...
--	    		progress = AI:GetArray(3)
--	    		AI:SetEctypeVarShort(mapid,88,progress)
--	    		AI:ScreenText( "GUID:03080000008", 2 )
--					AI:SetEctypeVarInteger( mapid, 119, hplose )
--					AI:SetEctypeVarShort(mapid,83,1)--?BOSS????
--		      AI:SummonMonsterByPos(52382,216,80,180)
--		      AI:SummonMonsterByPos(52441,216,80,180)
