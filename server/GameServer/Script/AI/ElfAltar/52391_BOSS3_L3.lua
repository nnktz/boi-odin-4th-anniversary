...
--				AI:UseSkill(2334,3)
		...
		if nIndex == 6 then--??3?? ??
				...
				if hinding == 1 then
					...
					AI:SetEctypeVarShort(mapid,89,3)
		...
		if nIndex == 7 then--??Lv2?? ??Lv2?BOSS
				local PosX = AI:GetPosX()
				local PosY = AI:GetPosY()
				AI:SummonMonsterByPos(52470,PosX-13,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX-10,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX-7,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX-4,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX+7,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX+10,PosY-5,1)
				AI:SummonMonsterByPos(52470,PosX+13,PosY-5,1)		
						
				AI:SummonMonsterByPos(52470,PosX-13,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX-10,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX-7,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX-4,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX+7,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX+10,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX+13,PosY+4,1)					
				
				AI:SummonMonsterByPos(52470,PosX-5,PosY+13,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY+10,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY+7,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY-4,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY-7,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY-10,1)
				AI:SummonMonsterByPos(52470,PosX-5,PosY-13,1)						
				
				AI:SummonMonsterByPos(52470,PosX+4,PosY+13,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY+10,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY+7,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY+4,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY-4,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY-7,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY-10,1)
				AI:SummonMonsterByPos(52470,PosX+4,PosY-13,1)					
		...
		if nIndex == 8 then--?????? ??Lv2?BOSS
			local PosX = AI:GetPosX()
			local PosY = AI:GetPosY()
			Boss1 = AI:GetEctypeVarShort(mapid,62)
			Boss2 = AI:GetEctypeVarShort(mapid,63)
			a = AI:GetArray(8)
			hpn = AI:GetHP()
			hpmax = AI:GetHPMax()
			hplose = hpmax - hpn 
			if a == 1 then
				if Boss1 == 1 then--BOSS1 DEAD
					if Boss2 == 1 then--BOSS2 DEAD
						AI:SetArray(8,2)
					else
						AI:SetArray(3,0)
		...
		-----------------------------------------------------------??BOSS??
	    	...
	    	if LimitY <= 85 	then
	    		...
	    		AI:ScreenText( "Sylvani Oakleaf: I must return to my altar.", 2 )    		
					...
					AI:SummonMonsterByPos(52391,75,103,180)
