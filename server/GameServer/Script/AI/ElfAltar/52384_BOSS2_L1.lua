...
--				AI:UseSkill(2334,3)
		...
		if nIndex == 8 then--?????? ??Lv2?BOSS
			...
			if SummonLv2 == 2 then
				AI:PlayAction("specialidle",0,0)
				AI:ScreenText("Valis Hailstorm: Transform!",1)
				AI:SetArray(7,3)
			end
			if SummonLv2 == 3 then	
				...
				AI:SummonMonsterByPos(52385,167,240,90)		
				AI:SummonMonsterByPos(52467,167,240,90)		
				AI:SetArray(7,4)
				AI:Exit()	
			end
		...
		-----------------------------------------------------------??BOSS??
	    	...
	    	if LimitX <= 135 	then
	    		...
	    		AI:ScreenText( "Valis Hailstorm: I must return to my altar.", 2 )    		
					...
					AI:SummonMonsterByPos(52384,167,240,180)
