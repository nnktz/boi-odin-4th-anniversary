...
function Event_OnTimer(nAI,nIndex, nCount)
    ...
    if nIndex == 0 then
        AI:ScreenText( "Greed seems to carry much silver and jewelry.", 2 )
        AI:SetTimer(1,4000,1)
    end
    if nIndex == 1 then
        AI:Say("Chest is too heavy, don't touch it if I set it down, ok?")
    ...
    if nIndex == 2 then
        ...
        AI:SummonMonsterByPos( 51565 , x , y )
        AI:Exit()
    end
end
