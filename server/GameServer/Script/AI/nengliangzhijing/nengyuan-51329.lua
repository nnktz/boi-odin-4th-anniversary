	...
	--		Author:?? 
	--		Class: Lua
	--		AIName:nengliangzhijing-51329.lua
	--		Backup:
	---------------------------------------------
...
----------------------------------------------------------------------------------    	   
    	   --?1?
			...
			--?2?
			elseif a == 1 then
				AI:ScreenText("The 2nd wave has breached the right Portal!",2)
				AI:SetTimer(1,2000,1)
			--?3?
			elseif a == 2 then
				AI:ScreenText("The 3rd wave has breached the middle Portal!",2)
				AI:SetTimer(1,2000,1) 
			--?4?
			elseif a == 3 then
				AI:ScreenText("The 4th wave has breached the right Portal!",2)
				AI:SetTimer(1,2000,1) 
			--?5?
			elseif a == 4 then
...
-------------------------------------------------------------------------------			
			--?6?
			elseif a == 5 then
				AI:ScreenText("The 6th wave has breached the middle Portal!",2)
				AI:SetTimer(1,2000,1)
			--?7?
			elseif a == 6 then
				AI:ScreenText("The 7th wave has breached the left Portal!",2)
				AI:SetTimer(1,2000,1)
			--?8?
			elseif a == 7 then
				AI:ScreenText("The 8th wave has breached the middle Portal!",2)
				AI:SetTimer(1,2000,1) 
			--?9?
			elseif a == 8 then
...
-----------------------------------------------------------------------------
			...
			--?12?
			elseif a == 11 then
				AI:ScreenText("The 12th wave has breached the right Portal!",2)
				AI:SetTimer(1,2000,1)
			--?13?
			elseif a == 12 then
			...
			--?14?
			elseif a == 13 then
				AI:ScreenText("The 14th wave has breached the left Portal!",2)
				AI:SetTimer(1,2000,1) 
			--?15?
			elseif a == 14 then
...
-------------------------------------------------------------------------------
			--?16?
			elseif a == 15 then
				AI:SetTimer(2,3000,3)
			--?17?
			elseif a == 16 then
				AI:SetTimer(2,3000,4) 
			--?18?
			elseif a == 17 then
				AI:SetTimer(2,3000,4) 
			--?19?
 ...
 -----------------------------------------------------------------------   	   
			...
			if a == 0 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51353,24,lv,131,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51353,24,lv,131,147)
			...
			elseif a == 1 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51355,24,lv,177,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51355,24,lv,177,147)
						AI:SetTimer(0,15000,1)
			...
			elseif a == 2 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51354,24,lv,154,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51354,24,lv,154,147)
						AI:SetTimer(0,15000,1)
...
--------------------------------------------------------------------------------
			...
			elseif a == 19 then
				if b == 0 then
					AI:SummonLevelMonsterByPos(51369,27,lv,154,147)
...
--------------------------------------------------------------------------------
			...
			elseif a == 20 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51353,25,lv,131,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51353,25,lv,131,147)
			...
			elseif a == 21 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51355,25,lv,177,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51355,25,lv,177,147)
						AI:SetTimer(0,25000,1) 
			...
			elseif a == 22 then
				if b >= 0 then
					if b <= 8 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51354,25,lv,154,147)
						AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51354,25,lv,154,147)
						AI:SetTimer(0,25000,1) 
...
--------------------------------------------------------------------------------
			...
			elseif a == 26 then
				if b >= 0 then
					if b <= 3 then
						...
						AI:SummonLevelMonsterByPos(51354,25,lv,154,147)
						AI:SummonLevelMonsterByPos(51355,25,lv,177,147)	
						AI:SetTimer(0,45000,1) 
						AI:SetArray(1,27)
						AI:SetArray(2,0)
					end
				end
			--?28?3?5?51353 51354 51355
			elseif a == 27 then
				if b >= 0 then
					if b <= 3 then
						b = b + 1
			...
			elseif a == 29 then
				if b == 0 then
					AI:SummonLevelMonsterByPos(51370,28,lv,154,147)
...
--------------------------------------------------------------------------------
			...
			elseif a == 37 then
				if b >= 0 then
					if b <= 1 then
						...
						AI:SummonLevelMonsterByPos(51354,25,lv,154,147)	
						AI:SummonLevelMonsterByPos(51355,25,lv,177,147)
						AI:SetTimer(0,31000,1) 
						AI:SetArray(1,38)
						AI:SetArray(2,0) 
					end 
				end
			--?39?4?51353 51354 51355
			elseif a == 38 then
				if b >= 0 then
					if b <= 2 then
						b = b + 1
						AI:SummonLevelMonsterByPos(51353,26,lv,131,147)
						AI:SummonLevelMonsterByPos(51354,26,lv,154,147)	
						AI:SummonLevelMonsterByPos(51355,26,lv,177,147)						
                    	AI:SetArray(2,b)
					else
						AI:SummonLevelMonsterByPos(51353,26,lv,131,147)
						AI:SummonLevelMonsterByPos(51354,26,lv,154,147)	
						AI:SummonLevelMonsterByPos(51355,26,lv,177,147)
						AI:SetTimer(0,28000,1) 
						AI:SetArray(1,39)
						AI:SetArray(2,0) 
					end 
				end
			...
			elseif a == 39 then
				if b == 0 then
					AI:SummonLevelMonsterByPos(51358,28,lv,154,147)
					AI:SetTimer(0,57000,1) 
					AI:SetArray(1,40)
					AI:SetArray(2,0) 
				end
