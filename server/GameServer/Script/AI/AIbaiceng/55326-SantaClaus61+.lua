...
function Event_ReadSeekPos(nAI)			
	...
	--???????50-100,?????50,50
	mapid = AI:GetMapID()
	AI:AddSeekPos( mapid , 186 , 126 )
	AI:AddSeekPos( mapid , 172 , 120 )
	AI:AddSeekPos( mapid , 158 , 136 )
	AI:AddSeekPos( mapid , 174 , 151 )
	AI:AddSeekPos( mapid , 185 , 143 )
	AI:AddSeekPos( mapid , 200 , 138 )
