...
function Event_OnDead(nAI)	
	...
	AI:ScreenText("God of War: You've made the right choice. I'll become your ally. Take this with you, God of War's Fury!", 2)
	
	mapid = AI:GetMapID()
	AI:SetEctypeVarShort(mapid,11,0)
	AI:SetEctypeVarShort(mapid,21,1)
	SavedPid = AI:GetArray(11)
	AI:AddPlayerStatus(SavedPid, 6458, 1)
