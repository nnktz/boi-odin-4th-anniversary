...
function Event_OnDead(nAI)	
	...
	AI:ScreenText("Odin: You've made the right choice. I'll become your ally. Take this with you, Divine Light!", 2)
	
	mapid = AI:GetMapID()
	AI:SetEctypeVarShort(mapid,12,0)
	AI:SetEctypeVarShort(mapid,22,1)
	SavedPid = AI:GetArray(11)
	AI:AddPlayerStatus(SavedPid, 6459, 1)
