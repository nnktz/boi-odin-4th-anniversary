...
function Event_OnDead(nAI)	
	...
	AI:ScreenText("Thor: You've made the right choice. I'll become your ally. Take this with you, Thor's Lightning!", 2)
	
	mapid = AI:GetMapID()
	AI:SetEctypeVarShort(mapid,13,0)
	AI:SetEctypeVarShort(mapid,23,1)
	SavedPid = AI:GetArray(11)
	AI:AddPlayerStatus(SavedPid, 6460, 1)
