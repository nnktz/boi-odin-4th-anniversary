...
function Event_OnTimer(nAI,nIndex, nCount)
    local AI = GetMonsterAI(nAI)
        ...
        if rand == 0 then
            ...
            AI:Say("Arbyss, I summon you from hell. Fight for me!")
            AI:SummonMonster(30047,1)
        end
        if rand == 1 then
            ...
            AI:Say("Britacesk, I summon you from hell. Fight for me!")
            AI:SummonMonster(30048,1)
        end
        if rand == 2 then
            ...
            AI:Say("Molmes, I summon you from hell. Fight for me!")
            AI:SummonMonster(30046,1)
        end
        if rand == 3 then
            ...
            AI:Say("My queen forgets your sorrow. I summon you from hell. Fight for me!")
            AI:SummonMonster(30045,1)
        end
    end
    if nIndex == 1 then
        --????
...
t = AI:HaveAttackTarget()
    if t == false then
        ...
        if a == 0 then
            if HP < HPMAX then
                AI:Say("I'm Set, brother of Osiris. You mortals will surrender to me before this is over!")
                --????
                r = AI:GetRand(3)
                if r == 0 then
                    AI:Say("Fire Storm!")
