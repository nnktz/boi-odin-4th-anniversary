...
t = AI:HaveAttackTarget()
    if t == false then
        ...
        if a == 0 then
            if HP < HPMAX then
                AI:Say("No matter how much I eat, I remain hungry; no matter how many women I love, I remain lonely.  I long for the smell of the sea...")
                --??ID 
                AI:AddSkill(8857,3)
                AI:UseSkill(8857,3)
        ...
        if a == 1 then
            if HP < HPMAX * 0.9 then
                AI:Say("Greed isn't so bad! Look how far I've come!")
                --??? 
                AI:SummonMonster(51136,1)
        ...
        if a == 2 then
            if HP < HPMAX * 0.6 then
                AI:Say("You've wasted too much of my time! You die, now!")
                --????ID 
                AI:AddSkill(8860,3)
                AI:UseSkill(8860,3)
