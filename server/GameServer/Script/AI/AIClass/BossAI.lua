	...
	--tEvents??:{{"GUID:02680000000"(????????-1),"GUID:02680000001"(?????????-1),{{???????,???????}...}(???????,???-1),{{?????ID,???????,?????X??(??????-1),?????Y??(??????-1)}...}(???????,???-1)},...}
	--tEvents??:{ {"GUID:02680000002" , -1 , {{2027,1},{8032,1},{8033,1}} , {51795,100,120}} , {"GUID:02680000003" , -1 , -1 , -1} }
	...
	--????AI??
	--nArrayNum ?????????????
	--tEvents??:{{"GUID:02680000004","GUID:02680000005"(????????-1),"GUID:02680000006"(?????????-1),{{???????,???????}...}(???????,???-1),{{?????ID,???????,?????X??,?????Y??}...}(???????,???-1),{{?????????,???????,???????}...}(???????,???-1),...}
	...
	--??????????AI???
	--tEvents??:{????,"GUID:02680000007"(????????-1),"GUID:02680000008"(?????????-1),{{???????,???????}...}(???????,???-1),{{?????ID,???????,?????X??,?????Y??}...}(???????,???-1),????(-1????,1???,2?????)}
	...
	--??????????AI???
	--tEvents??:{????,"GUID:02680000009"(????????-1),"GUID:02680000010"(?????????-1),{{???????,???????}...}(???????,???-1),{{?????ID,???????,?????X??,?????Y??}...}(???????,???-1),????(-1????,1???,2?????)}
