...
//62619	????????????			2
			...
			if $randombuff > $giftbuffpre
				if $randombuff <= $giftbuff
					...
					#name = GetPlayerInfo(-1,"name")
					BC("screen","servergroup",-1,"Player",#name," used the Soul Eater card and was lucky enough to receive a Soul Eater Pet Egg.")
					BC("chat","servergroup",-1,"Player",#name," used the Soul Eater card and was lucky enough to receive a Soul Eater Pet Egg.")
				endif
			endif
			$giftbuffpre = $giftbuff
//64181	????????			1
...
//5384	4????			3
			...
			if $randombuff > $giftbuffpre
				if $randombuff <= $giftbuff
					...
					#name = GetPlayerInfo(-1,"name")
					BC("screen","servergroup",-1,"Player",#name," used the Soul Eater card and was lucky enough to receive a Gem of Hel LV4!")
					BC("chat","servergroup",-1,"Player",#name," used the Soul Eater card and was lucky enough to receive a Gem of Hel LV4!")
				endif
			endif
			$giftbuffpre = $giftbuff
//60099	13??????			2
