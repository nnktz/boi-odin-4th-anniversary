...
//						BC("screen", "servergroup", -1, "The hero ",#name, "GUID:07016000002" )
//						BC("chat", "servergroup", -1, "The hero ",#name, "GUID:07016000004" )
					endif
				endif
				...
				if $random_item_2 > 9850
					if $random_item_2 <= 9925
						...
						#name = GetPlayerInfo(-1 , "name")
//						BC("screen", "servergroup", -1, "The hero ",#name, "GUID:07016000006" )
//						BC("chat", "servergroup", -1, "The hero ",#name, "GUID:07016000008" )
					endif
				endif
