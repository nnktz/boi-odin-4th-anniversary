	...
	function OnUseItem(){
		...
		if $del_count == 0
			...
			if $random_item_2 <= 2
				...
				BC("screen", "servergroup", -1, "The hero ",#name," opened a Flame Roar and found a Stardust Coin!" )
				BC("chat", "servergroup", -1, "The hero ",#name," opened a Flame Roar and found a Stardust Coin!" )
			endif
			...
			if $random_item_2 > 2
				if $random_item_2 <= 3
					...
					#name = GetPlayerInfo(-1 , "name")
					BC("screen", "servergroup", -1, "The hero ",#name," opened a Flame Roar and found the Demonlord Mount!" )
					BC("chat", "servergroup", -1, "The hero ",#name," opened a Flame Roar and found the Demonlord Mount!" )
				endif
			endif
