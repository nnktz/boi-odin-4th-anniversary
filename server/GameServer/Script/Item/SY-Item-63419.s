...
//					BC( "chat", "player", -1, "GUID:07744000010" )
//					BC( "dialogbox", "player", -1, "GUID:07744000011" )
//					return
//				endif
				if $n == 1
					SetPlayerVar( -1, 3680 , 87 )
...
//				if $n == 1
//					SetPlayerVar( -1, 3680 , 129 )
//					BC( "chat", "player", -1, "GUID:07744000018" )
//					BC( "dialogbox", "player", -1, "GUID:07744000019" )
//					return
//				endif
				if $n == 1
					SetPlayerVar( -1, 3680 , 3 )
...
//				if $n == 1
//					SetPlayerVar( -1, 3680 , 129 )
//					BC( "chat", "player", -1, "GUID:07744000026" )
//					BC( "dialogbox", "player", -1, "GUID:07744000027" )
//					return
//				endif
				if $n == 1
					SetPlayerVar( -1, 3680 , 3 )
...
//				if $n == 1
//					SetPlayerVar( -1, 3680 , 129 )
//					BC( "chat", "player", -1, "GUID:07744000034" )
//					BC( "dialogbox", "player", -1, "GUID:07744000035" )
//					return
//				endif
				if $n == 1
					SetPlayerVar( -1, 3680 , 3 )
...
//				if $n == 1
//					SetPlayerVar( -1, 3680 , 129 )
//					BC( "chat", "player", -1, "GUID:07744000042" )
//					BC( "dialogbox", "player", -1, "GUID:07744000043" )
//					return
//				endif
				if $n == 1
					SetPlayerVar( -1, 3680 , 3 )
