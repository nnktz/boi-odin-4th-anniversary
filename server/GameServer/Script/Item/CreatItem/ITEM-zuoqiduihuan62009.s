	...
	function OnUseItem(){
		...
		//5:??
			if $pro == 1
				...
				//BC( "screen", "player", -1, "GUID:06424000002" )
				return
			endif
			if $pro == 2
				AddPlayerInfo( -1, "item", 62000, 1 )
				//BC( "screen", "player", -1, "GUID:06424000003" )
				return
			endif
			if $pro == 3
				AddPlayerInfo( -1, "item", 62001, 1 )
				//BC( "screen", "player", -1, "GUID:06424000004" )
				return
			endif
			if $pro == 4
				AddPlayerInfo( -1, "item", 62002, 1 )
				//BC( "screen", "player", -1, "GUID:06424000005" )
				return
			endif
			if $pro == 5
				AddPlayerInfo( -1, "item", 62004, 1 )
				//BC( "screen", "player", -1, "GUID:06424000006" )
				return
				AddPlayerInfo( -1, "item", 62004, 1 )
				//BC( "screen", "player", -1, "GUID:06424000007" )
				return
			endif	
			if $pro == 6
				AddPlayerInfo( -1, "item", 62081, 1 )
				//BC( "screen", "player", -1, "GUID:06424000008" )
				return
			endif	
		endif
