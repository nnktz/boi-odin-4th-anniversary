...
function OnUseItem(){
  ...
  if $level < 70
     BC( "screen", "player", -1, "You must reach LV70 before you can open this Rookie Chest!" )
     BC( "chat", "player", -1, "You must reach LV70 before you can open this Rookie Chest!" )
     return
  endif
  ...
  if $bag_count < 3
		 BC( "screen", "player", -1, "Not enough space in your bag. Please clear some space to open the Rookie Chest!" )
