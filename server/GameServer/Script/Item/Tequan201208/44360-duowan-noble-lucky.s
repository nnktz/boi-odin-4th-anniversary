...
//                    BC( "screen", "player", -1, "GUID:07896000006" )
//                    BC( "screen", "server", -1, "GUID:07896000007",#name,"GUID:07896000008" )
//                 endif
//
//                 if $a == 2
//                    AddPlayerInfo( -1, "item", 62006, 1 )
//                    BC( "screen", "player", -1, "GUID:07896000009" )
//                    BC( "screen", "server", -1, "GUID:07896000010",#name,"GUID:07896000011" )
//                 endif
//
//   		           if $a == 3
//     		            AddPlayerInfo( -1, "item", 62019, 1 )
//    		            BC( "screen", "player", -1, "GUID:07896000012" )
//    	              BC( "screen", "server", -1, "GUID:07896000013",#name,"GUID:07896000014" )
//  		           endif
//
// 		             if $a == 4
//    		            AddPlayerInfo( -1, "item", 62102, 1 )
//     		            BC( "screen", "player", -1, "GUID:07896000015" )
//    			        	BC( "screen", "server", -1, "GUID:07896000016",#name,"GUID:07896000017" )
//  			         endif
//
//  				       if $a == 5
//     	              AddPlayerInfo( -1, "item", 62003, 1 )
//    				        BC( "screen", "player", -1, "GUID:07896000018" )
//    				        BC( "screen", "server", -1, "GUID:07896000019",#name,"GUID:07896000020" )
// 				         endif
//
//  				       if $a == 6
//   					        AddPlayerInfo( -1, "item", 62045, 1 )
//    				        BC( "screen", "player", -1, "GUID:07896000021" )
//    				        BC( "screen", "server", -1, "GUID:07896000022",#name,"GUID:07896000023" )
//  		           endif
//
//  				       if $a == 7
//    			          AddPlayerInfo( -1, "item", 62057, 1 )
//    				        BC( "screen", "player", -1, "GUID:07896000024" )
//   					        BC( "screen", "server", -1, "GUID:07896000025",#name,"GUID:07896000026" )
// 				         endif
//
//  				       if $a == 8
//    				        AddPlayerInfo( -1, "item", 62058, 1 )
//    				        BC( "screen", "player", -1, "GUID:07896000027" )
//     				        BC( "screen", "server", -1, "GUID:07896000028",#name,"GUID:07896000029" )
// 				         endif
//
// 				         if $a == 9
//     				        AddPlayerInfo( -1, "item", 62070, 1 )
//     				        BC( "screen", "player", -1, "GUID:07896000030" )
//    				        BC( "screen", "server", -1, "GUID:07896000031",#name,"GUID:07896000032" )
//  				       endif
//
// 				         if $a == 10
//    				        AddPlayerInfo( -1, "item", 62061, 1 )
//     				        BC( "screen", "player", -1, "GUID:07896000033" )
//    				        BC( "screen", "server", -1, "GUID:07896000034",#name,"GUID:07896000035" )
//  				       endif
//
// 				         if $a == 11
//     				        AddPlayerInfo( -1, "item", 62038, 1 )
//     				        BC( "screen", "player", -1, "GUID:07896000036" )
//    				        BC( "screen", "server", -1, "GUID:07896000037",#name,"GUID:07896000038" )
//  				       endif
//
//  				       if $a == 12
//   					        AddPlayerInfo( -1, "item", 62039, 1 )
//       			        BC( "screen", "player", -1, "GUID:07896000039" )
//   					        BC( "screen", "server", -1, "GUID:07896000040",#name,"GUID:07896000041" )
//	               endif
//  //????
