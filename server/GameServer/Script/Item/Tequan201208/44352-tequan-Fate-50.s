...
function OnUseItem(){
  ...
  if $level < 50
     BC( "screen", "player", -1, "You must reach LV50 before you can open this Rookie Chest!" )
     BC( "chat", "player", -1, "You must reach LV50 before you can open this Rookie Chest!" )
     return
  endif
