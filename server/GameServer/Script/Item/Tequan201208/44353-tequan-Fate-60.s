...
function OnUseItem(){
  ...
  if $level < 60
     BC( "screen", "player", -1, "You must reach LV60 before you can open this Rookie Chest!" )
     BC( "chat", "player", -1, "You must reach LV60 before you can open this Rookie Chest!" )
     return
  endif
