...
//                    BC( "screen", "player", -1, "GUID:07895000006" )
//                    BC( "screen", "server", -1, "GUID:07895000007",#name,"GUID:07895000008" )
//                 endif
//
//                 if $a == 2
//                    AddPlayerInfo( -1, "item", 62006, 1 )
//                    BC( "screen", "player", -1, "GUID:07895000009" )
//                    BC( "screen", "server", -1, "GUID:07895000010",#name,"GUID:07895000011" )
//                 endif
//
//   		           if $a == 3
//     		            AddPlayerInfo( -1, "item", 62019, 1 )
//    		            BC( "screen", "player", -1, "GUID:07895000012" )
//    	              BC( "screen", "server", -1, "GUID:07895000013",#name,"GUID:07895000014" )
//  		           endif
//
// 		             if $a == 4
//    		            AddPlayerInfo( -1, "item", 62102, 1 )
//     		            BC( "screen", "player", -1, "GUID:07895000015" )
//    			        	BC( "screen", "server", -1, "GUID:07895000016",#name,"GUID:07895000017" )
//  			         endif
//
//  				       if $a == 5
//     	              AddPlayerInfo( -1, "item", 62003, 1 )
//    				        BC( "screen", "player", -1, "GUID:07895000018" )
//    				        BC( "screen", "server", -1, "GUID:07895000019",#name,"GUID:07895000020" )
// 				         endif
//
//  				       if $a == 6
//   					        AddPlayerInfo( -1, "item", 62045, 1 )
//    				        BC( "screen", "player", -1, "GUID:07895000021" )
//    				        BC( "screen", "server", -1, "GUID:07895000022",#name,"GUID:07895000023" )
//  		           endif
//
//  				       if $a == 7
//    			          AddPlayerInfo( -1, "item", 62057, 1 )
//    				        BC( "screen", "player", -1, "GUID:07895000024" )
//   					        BC( "screen", "server", -1, "GUID:07895000025",#name,"GUID:07895000026" )
// 				         endif
//
//  				       if $a == 8
//    				        AddPlayerInfo( -1, "item", 62058, 1 )
//    				        BC( "screen", "player", -1, "GUID:07895000027" )
//     				        BC( "screen", "server", -1, "GUID:07895000028",#name,"GUID:07895000029" )
// 				         endif
//
// 				         if $a == 9
//     				        AddPlayerInfo( -1, "item", 62070, 1 )
//     				        BC( "screen", "player", -1, "GUID:07895000030" )
//    				        BC( "screen", "server", -1, "GUID:07895000031",#name,"GUID:07895000032" )
//  				       endif
//
// 				         if $a == 10
//    				        AddPlayerInfo( -1, "item", 62061, 1 )
//     				        BC( "screen", "player", -1, "GUID:07895000033" )
//    				        BC( "screen", "server", -1, "GUID:07895000034",#name,"GUID:07895000035" )
//  				       endif
//
// 				         if $a == 11
//     				        AddPlayerInfo( -1, "item", 62038, 1 )
//     				        BC( "screen", "player", -1, "GUID:07895000036" )
//    				        BC( "screen", "server", -1, "GUID:07895000037",#name,"GUID:07895000038" )
//  				       endif
//
//  				       if $a == 12
//   					        AddPlayerInfo( -1, "item", 62039, 1 )
//       			        BC( "screen", "player", -1, "GUID:07895000039" )
//   					        BC( "screen", "server", -1, "GUID:07895000040",#name,"GUID:07895000041" )
//	               endif
//  //????
