...
//                    BC( "screen", "player", -1, "GUID:08063000006" )
//                    BC( "screen", "server", -1, "GUID:08063000007",#name,"GUID:08063000008" )
//                 endif
//
//                 if $a == 2
//                    AddPlayerInfo( -1, "item", 62006, 1 )
//                    BC( "screen", "player", -1, "GUID:08063000009" )
//                    BC( "screen", "server", -1, "GUID:08063000010",#name,"GUID:08063000011" )
//                 endif
//
//   		           if $a == 3
//     		            AddPlayerInfo( -1, "item", 62019, 1 )
//    		            BC( "screen", "player", -1, "GUID:08063000012" )
//    	              BC( "screen", "server", -1, "GUID:08063000013",#name,"GUID:08063000014" )
//  		           endif
//
// 		             if $a == 4
//    		            AddPlayerInfo( -1, "item", 62102, 1 )
//     		            BC( "screen", "player", -1, "GUID:08063000015" )
//    			        	BC( "screen", "server", -1, "GUID:08063000016",#name,"GUID:08063000017" )
//  			         endif
//
//  				       if $a == 5
//     	              AddPlayerInfo( -1, "item", 62003, 1 )
//    				        BC( "screen", "player", -1, "GUID:08063000018" )
//    				        BC( "screen", "server", -1, "GUID:08063000019",#name,"GUID:08063000020" )
// 				         endif
//
//  				       if $a == 6
//   					        AddPlayerInfo( -1, "item", 62045, 1 )
//    				        BC( "screen", "player", -1, "GUID:08063000021" )
//    				        BC( "screen", "server", -1, "GUID:08063000022",#name,"GUID:08063000023" )
//  		           endif
//
//  				       if $a == 7
//    			          AddPlayerInfo( -1, "item", 62057, 1 )
//    				        BC( "screen", "player", -1, "GUID:08063000024" )
//   					        BC( "screen", "server", -1, "GUID:08063000025",#name,"GUID:08063000026" )
// 				         endif
//
//  				       if $a == 8
//    				        AddPlayerInfo( -1, "item", 62058, 1 )
//    				        BC( "screen", "player", -1, "GUID:08063000027" )
//     				        BC( "screen", "server", -1, "GUID:08063000028",#name,"GUID:08063000029" )
// 				         endif
//
// 				         if $a == 9
//     				        AddPlayerInfo( -1, "item", 62070, 1 )
//     				        BC( "screen", "player", -1, "GUID:08063000030" )
//    				        BC( "screen", "server", -1, "GUID:08063000031",#name,"GUID:08063000032" )
//  				       endif
//
// 				         if $a == 10
//    				        AddPlayerInfo( -1, "item", 62061, 1 )
//     				        BC( "screen", "player", -1, "GUID:08063000033" )
//    				        BC( "screen", "server", -1, "GUID:08063000034",#name,"GUID:08063000035" )
//  				       endif
//
// 				         if $a == 11
//     				        AddPlayerInfo( -1, "item", 62038, 1 )
//     				        BC( "screen", "player", -1, "GUID:08063000036" )
//    				        BC( "screen", "server", -1, "GUID:08063000037",#name,"GUID:08063000038" )
//  				       endif
//
//  				       if $a == 12
//   					        AddPlayerInfo( -1, "item", 62039, 1 )
//       			        BC( "screen", "player", -1, "GUID:08063000039" )
//   					        BC( "screen", "server", -1, "GUID:08063000040",#name,"GUID:08063000041" )
//	               endif
//  //????
