...
//                    BC( "screen", "player", -1, "GUID:08062000006" )
//                    BC( "screen", "server", -1, "GUID:08062000007",#name,"GUID:08062000008" )
//                 endif
//
//                 if $a == 2
//                    AddPlayerInfo( -1, "item", 62006, 1 )
//                    BC( "screen", "player", -1, "GUID:08062000009" )
//                    BC( "screen", "server", -1, "GUID:08062000010",#name,"GUID:08062000011" )
//                 endif
//
//   		           if $a == 3
//     		            AddPlayerInfo( -1, "item", 62019, 1 )
//    		            BC( "screen", "player", -1, "GUID:08062000012" )
//    	              BC( "screen", "server", -1, "GUID:08062000013",#name,"GUID:08062000014" )
//  		           endif
//
// 		             if $a == 4
//    		            AddPlayerInfo( -1, "item", 62102, 1 )
//     		            BC( "screen", "player", -1, "GUID:08062000015" )
//    			        	BC( "screen", "server", -1, "GUID:08062000016",#name,"GUID:08062000017" )
//  			         endif
//
//  				       if $a == 5
//     	              AddPlayerInfo( -1, "item", 62003, 1 )
//    				        BC( "screen", "player", -1, "GUID:08062000018" )
//    				        BC( "screen", "server", -1, "GUID:08062000019",#name,"GUID:08062000020" )
// 				         endif
//
//  				       if $a == 6
//   					        AddPlayerInfo( -1, "item", 62045, 1 )
//    				        BC( "screen", "player", -1, "GUID:08062000021" )
//    				        BC( "screen", "server", -1, "GUID:08062000022",#name,"GUID:08062000023" )
//  		           endif
//
//  				       if $a == 7
//    			          AddPlayerInfo( -1, "item", 62057, 1 )
//    				        BC( "screen", "player", -1, "GUID:08062000024" )
//   					        BC( "screen", "server", -1, "GUID:08062000025",#name,"GUID:08062000026" )
// 				         endif
//
//  				       if $a == 8
//    				        AddPlayerInfo( -1, "item", 62058, 1 )
//    				        BC( "screen", "player", -1, "GUID:08062000027" )
//     				        BC( "screen", "server", -1, "GUID:08062000028",#name,"GUID:08062000029" )
// 				         endif
//
// 				         if $a == 9
//     				        AddPlayerInfo( -1, "item", 62070, 1 )
//     				        BC( "screen", "player", -1, "GUID:08062000030" )
//    				        BC( "screen", "server", -1, "GUID:08062000031",#name,"GUID:08062000032" )
//  				       endif
//
// 				         if $a == 10
//    				        AddPlayerInfo( -1, "item", 62061, 1 )
//     				        BC( "screen", "player", -1, "GUID:08062000033" )
//    				        BC( "screen", "server", -1, "GUID:08062000034",#name,"GUID:08062000035" )
//  				       endif
//
// 				         if $a == 11
//     				        AddPlayerInfo( -1, "item", 62038, 1 )
//     				        BC( "screen", "player", -1, "GUID:08062000036" )
//    				        BC( "screen", "server", -1, "GUID:08062000037",#name,"GUID:08062000038" )
//  				       endif
//
//  				       if $a == 12
//   					        AddPlayerInfo( -1, "item", 62039, 1 )
//       			        BC( "screen", "player", -1, "GUID:08062000039" )
//   					        BC( "screen", "server", -1, "GUID:08062000040",#name,"GUID:08062000041" )
//	               endif
//  //????
