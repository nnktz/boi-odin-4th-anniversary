...
//					#name = GetPlayerInfo(-1,"name")
//					BC("screen","servergroup",-1,"Player",#name,"GUID:06593000016")
//					BC("chat","servergroup",-1,"Player",#name,"GUID:06593000018")
				endif
			endif
			$giftbuffpre = $giftbuff
//62617	?????????????			2
...
//5384	4????			1
			...
			if $randombuff > $giftbuffpre
				if $randombuff <= $giftbuff
					...
					#name = GetPlayerInfo(-1,"name")
					BC("screen","servergroup",-1,"Player",#name," used the Source of Chaos card and was lucky enough to receive a Gem of Hel LV4!")
					BC("chat","servergroup",-1,"Player",#name," used the Source of Chaos card and was lucky enough to receive a Gem of Hel LV4!")
				endif
			endif
			$giftbuffpre = $giftbuff
//63789	??????			50
