	...
	function OnUseItem(){
		...
		if $del_count == 0
			...
			if $use_number_mengma == $give_number_mengma
				...
				BC("screen", "servergroup", -1, "The hero ",#name, " opened a Christmas Joy Pack and received a Christmas Sled! Ho, ho, ho!" )
				BC("chat", "servergroup", -1, "The hero ",#name, " opened a Christmas Joy Pack and received a Christmas Sled! Ho, ho, ho!" )
